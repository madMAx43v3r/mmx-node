...
First chart is an overall overview using formulas created. Then two charts using real-life hdd-k29 plotting data to illustrate patterns. Those patterns repeat in other k-sizes. Decimal GiB numbers in overview chart have been rounded up. Less chance of underestimating combined size of plots.
...
| `80%` | &plusmn;0.217 GiB | &plusmn;0.327 GiB | &plusmn;0.485 GiB | &plusmn;0.711 GiB |

...
const vnx::Hash64 tx_info_t::VNX_CODE_HASH(0x4f1ec66b4a013215ull);
...
void tx_info_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, parents);
...
void tx_info_t::write(std::ostream& _out) const {
	...
	_out << ", \"parents\": "; vnx::write(_out, parents);
...
void tx_info_t::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "parents") {
			_entry.second.to(parents);
...
std::shared_ptr<vnx::TypeCode> tx_info_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x4f1ec66b4a013215ull);
...
void read(TypeInput& in, ::mmx::tx_info_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 12: vnx::read(in, value.parents, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::tx_info_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.parents, type_code, type_code->fields[12].code.data());

...
const vnx::Hash64 tx_entry_t::VNX_CODE_HASH(0x79f809a3fcdfb70dull);
...
void tx_entry_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, memo);
...
std::shared_ptr<vnx::TypeCode> tx_entry_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x79f809a3fcdfb70dull);
...
void read(TypeInput& in, ::mmx::tx_entry_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 7: vnx::read(in, value.memo, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::tx_entry_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.memo, type_code, type_code->fields[7].code.data());
}

...
const vnx::Hash64 Wallet_get_history_return::VNX_CODE_HASH(0x9aa506a95cbc0ca6ull);
...
std::shared_ptr<vnx::TypeCode> Wallet_get_history_return::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x9aa506a95cbc0ca6ull);
	...
	type_code->depends[0] = ::mmx::wallet::tx_entry_t::static_get_type_code();

...
const vnx::Hash64 RouterBase::VNX_CODE_HASH(0x3e6cc359ed5bded8ull);
	...
	:	MsgServer::MsgServer(_vnx_name)
{
	...
	vnx::read_config(vnx_name + ".max_peer_requests", max_peer_requests);
...
void RouterBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[33], 33); vnx::accept(_visitor, fork_check_interval);
	_visitor.type_field(_type_code->fields[34], 34); vnx::accept(_visitor, num_peers_out);
	_visitor.type_field(_type_code->fields[35], 35); vnx::accept(_visitor, min_sync_peers);
	_visitor.type_field(_type_code->fields[36], 36); vnx::accept(_visitor, max_peer_set);
	_visitor.type_field(_type_code->fields[37], 37); vnx::accept(_visitor, max_sent_cache);
	_visitor.type_field(_type_code->fields[38], 38); vnx::accept(_visitor, max_hash_cache);
	_visitor.type_field(_type_code->fields[39], 39); vnx::accept(_visitor, max_peer_requests);
...
void RouterBase::write(std::ostream& _out) const {
	...
	_out << ", \"max_peer_requests\": "; vnx::write(_out, max_peer_requests);
...
vnx::Object RouterBase::to_object() const {
	...
	_object["max_peer_requests"] = max_peer_requests;
...
void RouterBase::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "max_peer_requests") {
			_entry.second.to(max_peer_requests);
...
vnx::Variant RouterBase::get_field(const std::string& _name) const {
	...
	if(_name == "max_peer_requests") {
		return vnx::Variant(max_peer_requests);
	}
...
void RouterBase::set_field(const std::string& _name, const vnx::Variant& _value) {
	...
	} else if(_name == "max_peer_requests") {
		_value.to(max_peer_requests);
...
std::shared_ptr<vnx::TypeCode> RouterBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x3e6cc359ed5bded8ull);
...
void read(TypeInput& in, ::mmx::RouterBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(type_code->is_matched) {
		...
		if(const auto* const _field = type_code->field_map[39]) {
			vnx::read_value(_buf + _field->offset, value.max_peer_requests, _field->code.data());
		}
...
void write(TypeOutput& out, const ::mmx::RouterBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 79, value.fork_check_interval);
	vnx::write_value(_buf + 83, value.num_peers_out);
	vnx::write_value(_buf + 87, value.min_sync_peers);
	vnx::write_value(_buf + 91, value.max_peer_set);
	vnx::write_value(_buf + 95, value.max_sent_cache);
	vnx::write_value(_buf + 99, value.max_hash_cache);
	vnx::write_value(_buf + 103, value.max_peer_requests);

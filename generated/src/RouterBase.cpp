...
const vnx::Hash64 RouterBase::VNX_CODE_HASH(0x6b112e7a6b539344ull);
...
std::shared_ptr<vnx::TypeCode> RouterBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x6b112e7a6b539344ull);
...
void write(TypeOutput& out, const ::mmx::RouterBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 140, value.max_tx_upload);
	vnx::write_value(_buf + 148, value.max_pending_cost);

...
const vnx::Hash64 RouterBase::VNX_CODE_HASH(0xf1f3d617069ca16eull);
...
void RouterBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[39], 39); vnx::accept(_visitor, vdf_credits);
	_visitor.type_field(_type_code->fields[40], 40); vnx::accept(_visitor, block_credits);
	_visitor.type_field(_type_code->fields[41], 41); vnx::accept(_visitor, proof_credits);
	_visitor.type_field(_type_code->fields[42], 42); vnx::accept(_visitor, vdf_relay_cost);
	_visitor.type_field(_type_code->fields[43], 43); vnx::accept(_visitor, proof_relay_cost);
	_visitor.type_field(_type_code->fields[44], 44); vnx::accept(_visitor, block_relay_cost);
	_visitor.type_field(_type_code->fields[45], 45); vnx::accept(_visitor, max_node_credits);
	_visitor.type_field(_type_code->fields[46], 46); vnx::accept(_visitor, max_farmer_credits);
...
std::shared_ptr<vnx::TypeCode> RouterBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xf1f3d617069ca16eull);
...
void write(TypeOutput& out, const ::mmx::RouterBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 103, value.vdf_credits);
	vnx::write_value(_buf + 107, value.block_credits);
	vnx::write_value(_buf + 111, value.proof_credits);
	vnx::write_value(_buf + 115, value.vdf_relay_cost);
	vnx::write_value(_buf + 119, value.proof_relay_cost);
	vnx::write_value(_buf + 123, value.block_relay_cost);
	vnx::write_value(_buf + 127, value.max_node_credits);
	vnx::write_value(_buf + 131, value.max_farmer_credits);

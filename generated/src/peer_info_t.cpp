...
const vnx::Hash64 peer_info_t::VNX_CODE_HASH(0xd7084ef468abb475ull);
...
void peer_info_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, credits);
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, tx_credits);
	...
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, recv_timeout_ms);
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, connect_time_ms);
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, bytes_send);
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, bytes_recv);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, is_synced);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, is_blocked);
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, is_outbound);
...
std::shared_ptr<vnx::TypeCode> peer_info_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xd7084ef468abb475ull);

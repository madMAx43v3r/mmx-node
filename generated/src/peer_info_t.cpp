...
const vnx::Hash64 peer_info_t::VNX_CODE_HASH(0x1a1db23d1543ea5full);
...
void peer_info_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, ping_ms);
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, height);
	_visitor.type_field(_type_code->fields[3], 3); vnx::accept(_visitor, recv_timeout_ms);
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, connect_time_ms);
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, bytes_send);
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, bytes_recv);
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, is_synced);
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, is_blocked);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, is_outbound);
...
std::shared_ptr<vnx::TypeCode> peer_info_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x1a1db23d1543ea5full);
...
void write(TypeOutput& out, const ::mmx::peer_info_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 0, value.ping_ms);
	vnx::write_value(_buf + 4, value.height);
	vnx::write_value(_buf + 8, value.recv_timeout_ms);
	vnx::write_value(_buf + 16, value.connect_time_ms);
	vnx::write_value(_buf + 24, value.bytes_send);
	vnx::write_value(_buf + 32, value.bytes_recv);
	vnx::write_value(_buf + 40, value.is_synced);
	vnx::write_value(_buf + 41, value.is_blocked);
	vnx::write_value(_buf + 42, value.is_outbound);

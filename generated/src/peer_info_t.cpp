...
const vnx::Hash64 peer_info_t::VNX_CODE_HASH(0x466d357c483b0416ull);
...
std::shared_ptr<vnx::TypeCode> peer_info_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x466d357c483b0416ull);
...
void write(TypeOutput& out, const ::mmx::peer_info_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 65, value.is_blocked);
	vnx::write_value(_buf + 66, value.is_outbound);

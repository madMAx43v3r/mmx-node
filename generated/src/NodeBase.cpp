...
const vnx::Hash64 NodeBase::VNX_CODE_HASH(0xaeeda8433dc0b26full);
...
std::shared_ptr<vnx::TypeCode> NodeBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xaeeda8433dc0b26full);
...
void write(TypeOutput& out, const ::mmx::NodeBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 71, value.vdf_slave_mode);
	vnx::write_value(_buf + 72, value.exec_debug);
	vnx::write_value(_buf + 73, value.exec_profile);
	vnx::write_value(_buf + 74, value.exec_trace);

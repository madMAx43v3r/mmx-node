...
const vnx::Hash64 NodeBase::VNX_CODE_HASH(0x1be1b14891d95cdfull);
...
void NodeBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[34], 34); vnx::accept(_visitor, vdf_verify_max_pending);
	...
	_visitor.type_field(_type_code->fields[40], 40); vnx::accept(_visitor, exec_debug);
	_visitor.type_field(_type_code->fields[41], 41); vnx::accept(_visitor, exec_profile);
	_visitor.type_field(_type_code->fields[42], 42); vnx::accept(_visitor, exec_trace);
...
std::shared_ptr<vnx::TypeCode> NodeBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x1be1b14891d95cdfull);
...
void write(TypeOutput& out, const ::mmx::NodeBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 60, value.vdf_verify_max_pending);
	vnx::write_value(_buf + 64, value.opencl_device);
	vnx::write_value(_buf + 68, value.do_sync);
	vnx::write_value(_buf + 69, value.show_warnings);
	vnx::write_value(_buf + 70, value.vdf_slave_mode);
	vnx::write_value(_buf + 71, value.exec_debug);
	vnx::write_value(_buf + 72, value.exec_profile);
	vnx::write_value(_buf + 73, value.exec_trace);

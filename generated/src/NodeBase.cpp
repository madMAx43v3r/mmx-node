...
std::shared_ptr<vnx::TypeCode> NodeBase::static_create_type_code() {
	...
	type_code->methods[6] = ::mmx::Node_get_all_balances::static_get_type_code();
	type_code->methods[7] = ::mmx::Node_get_balance::static_get_type_code();
	type_code->methods[8] = ::mmx::Node_get_balances::static_get_type_code();
	type_code->methods[9] = ::mmx::Node_get_block::static_get_type_code();
	type_code->methods[10] = ::mmx::Node_get_block_at::static_get_type_code();
	type_code->methods[11] = ::mmx::Node_get_block_hash::static_get_type_code();
	type_code->methods[12] = ::mmx::Node_get_contract::static_get_type_code();
	type_code->methods[13] = ::mmx::Node_get_contract_at::static_get_type_code();
	type_code->methods[14] = ::mmx::Node_get_contract_balances::static_get_type_code();
	type_code->methods[15] = ::mmx::Node_get_contract_for::static_get_type_code();
	type_code->methods[16] = ::mmx::Node_get_contracts::static_get_type_code();
	type_code->methods[17] = ::mmx::Node_get_contracts_by::static_get_type_code();
	type_code->methods[18] = ::mmx::Node_get_contracts_owned_by::static_get_type_code();
	type_code->methods[19] = ::mmx::Node_get_exec_history::static_get_type_code();
	type_code->methods[20] = ::mmx::Node_get_farmed_block_count::static_get_type_code();
	type_code->methods[21] = ::mmx::Node_get_farmed_block_count_for::static_get_type_code();
	type_code->methods[22] = ::mmx::Node_get_farmed_blocks::static_get_type_code();
	type_code->methods[23] = ::mmx::Node_get_genesis_hash::static_get_type_code();
	type_code->methods[24] = ::mmx::Node_get_header::static_get_type_code();
	type_code->methods[25] = ::mmx::Node_get_header_at::static_get_type_code();
	type_code->methods[26] = ::mmx::Node_get_height::static_get_type_code();
	type_code->methods[27] = ::mmx::Node_get_history::static_get_type_code();
	...
	type_code->methods[35] = ::mmx::Node_get_synced_height::static_get_type_code();
	type_code->methods[36] = ::mmx::Node_get_total_balance::static_get_type_code();
	type_code->methods[37] = ::mmx::Node_get_total_balances::static_get_type_code();
	type_code->methods[38] = ::mmx::Node_get_total_supply::static_get_type_code();
	type_code->methods[39] = ::mmx::Node_get_trade_history::static_get_type_code();
	type_code->methods[40] = ::mmx::Node_get_trade_history_for::static_get_type_code();
	type_code->methods[41] = ::mmx::Node_get_transaction::static_get_type_code();
	type_code->methods[42] = ::mmx::Node_get_transactions::static_get_type_code();
	type_code->methods[43] = ::mmx::Node_get_tx_height::static_get_type_code();
	type_code->methods[44] = ::mmx::Node_get_tx_ids_at::static_get_type_code();
	type_code->methods[45] = ::mmx::Node_get_tx_ids_since::static_get_type_code();
	type_code->methods[46] = ::mmx::Node_get_tx_info::static_get_type_code();
	type_code->methods[47] = ::mmx::Node_get_tx_info_for::static_get_type_code();
	type_code->methods[48] = ::mmx::Node_get_virtual_plot_balance::static_get_type_code();
	type_code->methods[49] = ::mmx::Node_get_virtual_plots_for::static_get_type_code();
	type_code->methods[50] = ::mmx::Node_read_storage::static_get_type_code();
	type_code->methods[51] = ::mmx::Node_read_storage_array::static_get_type_code();

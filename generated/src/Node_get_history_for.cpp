...
std::string Node_get_history_for::get_type_name() const {
	return "mmx.Node.get_history_for";
}

const vnx::TypeCode* Node_get_history_for::get_type_code() const {
	return mmx::vnx_native_type_code_Node_get_history_for;
}

std::shared_ptr<Node_get_history_for> Node_get_history_for::create() {
	return std::make_shared<Node_get_history_for>();
}

std::shared_ptr<vnx::Value> Node_get_history_for::clone() const {
	return std::make_shared<Node_get_history_for>(*this);
}

void Node_get_history_for::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Node_get_history_for::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Node_get_history_for::accept(vnx::Visitor& _visitor) const {
...
void Node_get_history_for::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object Node_get_history_for::to_object() const {
	vnx::Object _object;
...
void Node_get_history_for::from_object(const vnx::Object& _object) {
...
vnx::Variant Node_get_history_for::get_field(const std::string& _name) const {
	if(_name == "addresses") {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Node_get_history_for& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Node_get_history_for& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Node_get_history_for::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Node_get_history_for::static_create_type_code() {
	...
	type_code->native_size = sizeof(::mmx::Node_get_history_for);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<Node_get_history_for>(); };
	type_code->is_const = true;
	type_code->return_type = ::mmx::Node_get_history_for_return::static_get_type_code();
...
void write(TypeOutput& out, const ::mmx::Node_get_history_for& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::vnx_native_type_code_Node_get_history_for;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::Node_get_history_for>(out);
	}

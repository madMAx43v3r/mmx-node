...
const vnx::Hash64 PlotHeader::VNX_CODE_HASH(0x6592ad71f75faac1ull);
...
void PlotHeader::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, plot_id);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, farmer_key);
	_visitor.type_field(_type_code->fields[15], 15); vnx::accept(_visitor, contract);
	_visitor.type_field(_type_code->fields[16], 16); vnx::accept(_visitor, plot_size);
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, table_offset_x);
	_visitor.type_field(_type_code->fields[18], 18); vnx::accept(_visitor, table_offset_y);
	_visitor.type_field(_type_code->fields[19], 19); vnx::accept(_visitor, table_offset_meta);
	_visitor.type_field(_type_code->fields[20], 20); vnx::accept(_visitor, table_offset_pd);
...
std::shared_ptr<vnx::TypeCode> PlotHeader::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x6592ad71f75faac1ull);
...
void read(TypeInput& in, ::mmx::PlotHeader& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 13: vnx::read(in, value.plot_id, type_code, _field->code.data()); break;
			case 14: vnx::read(in, value.farmer_key, type_code, _field->code.data()); break;
			case 15: vnx::read(in, value.contract, type_code, _field->code.data()); break;
			case 20: vnx::read(in, value.table_offset_pd, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::PlotHeader& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.plot_id, type_code, type_code->fields[13].code.data());
	vnx::write(out, value.farmer_key, type_code, type_code->fields[14].code.data());
	vnx::write(out, value.contract, type_code, type_code->fields[15].code.data());
	vnx::write(out, value.table_offset_pd, type_code, type_code->fields[20].code.data());
}

...
std::shared_ptr<vnx::TypeCode> WalletBase::static_create_type_code() {
	...
	type_code->methods[31] = ::mmx::Wallet_get_master_seed::static_get_type_code();
	type_code->methods[32] = ::mmx::Wallet_get_farmer_keys::static_get_type_code();
	type_code->methods[33] = ::mmx::Wallet_get_all_farmer_keys::static_get_type_code();

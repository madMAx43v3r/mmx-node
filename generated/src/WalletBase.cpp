...
std::shared_ptr<vnx::TypeCode> WalletBase::static_create_type_code() {
	...
	type_code->methods[1] = ::mmx::Wallet_add_token::static_get_type_code();
	type_code->methods[2] = ::mmx::Wallet_cancel_offer::static_get_type_code();
	...
	type_code->methods[21] = ::mmx::Wallet_get_contracts_owned::static_get_type_code();

...
const vnx::Hash64 WalletBase::VNX_CODE_HASH(0x833fd90ae22d23d0ull);
...
std::shared_ptr<vnx::TypeCode> WalletBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x833fd90ae22d23d0ull);
	...
	type_code->methods[21] = ::mmx::Wallet_get_address::static_get_type_code();
	type_code->methods[22] = ::mmx::Wallet_get_all_addresses::static_get_type_code();
	type_code->methods[23] = ::mmx::Wallet_get_master_seed::static_get_type_code();
	type_code->methods[24] = ::mmx::Wallet_get_farmer_keys::static_get_type_code();
	type_code->methods[25] = ::mmx::Wallet_get_all_farmer_keys::static_get_type_code();
...
std::shared_ptr<vnx::Value> WalletBase::vnx_call_switch(std::shared_ptr<const vnx::Value> _method, const vnx::request_id_t& _request_id) {
	switch(_method->get_type_hash()) {
		...
		case 0x3842658ae3c2d5ebull: {
			...
			_return_value->_ret_0 = send(_args->index, _args->amount, _args->dst_addr, _args->currency);
			return _return_value;
		}
		case 0x40c3c88665341592ull: {
			...
			_return_value->_ret_0 = send_from(_args->index, _args->amount, _args->dst_addr, _args->src_addr, _args->currency);
			return _return_value;
		}
		case 0x3c52811b834fbd3eull: {
			...
			_return_value->_ret_0 = mint(_args->index, _args->amount, _args->dst_addr, _args->currency);
			return _return_value;
		}
		case 0xcd71b07853d17497ull: {
			...
			_return_value->_ret_0 = deploy(_args->index, _args->contract);
			return _return_value;
		}
		...
		case 0x8b3f02747642c28dull: {
			...
			_return_value->_ret_0 = get_utxo_list_for(_args->index, _args->currency);
			return _return_value;
		}
		...
		case 0x5be581d54ae69a4ull: {
			...
			_return_value->_ret_0 = get_balances(_args->index);
			return _return_value;
		}

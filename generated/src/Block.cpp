...
const vnx::Hash64 Block::VNX_CODE_HASH(0x87f071be0e1484b6ull);
...
void Block::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, tx_count);
	_visitor.type_field(_type_code->fields[15], 15); vnx::accept(_visitor, tx_cost);
	_visitor.type_field(_type_code->fields[16], 16); vnx::accept(_visitor, tx_fees);
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, tx_hash);
	_visitor.type_field(_type_code->fields[18], 18); vnx::accept(_visitor, farmer_sig);
	_visitor.type_field(_type_code->fields[19], 19); vnx::accept(_visitor, content_hash);
	_visitor.type_field(_type_code->fields[20], 20); vnx::accept(_visitor, tx_list);
...
std::shared_ptr<vnx::TypeCode> Block::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x87f071be0e1484b6ull);
	...
	type_code->methods[7] = ::mmx::BlockHeader_get_header::static_get_type_code();
...
void read(TypeInput& in, ::mmx::Block& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 17: vnx::read(in, value.tx_hash, type_code, _field->code.data()); break;
			case 18: vnx::read(in, value.farmer_sig, type_code, _field->code.data()); break;
			case 19: vnx::read(in, value.content_hash, type_code, _field->code.data()); break;
			case 20: vnx::read(in, value.tx_list, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::Block& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 44, value.tx_count);
	vnx::write_value(_buf + 48, value.tx_cost);
	vnx::write_value(_buf + 52, value.tx_fees);
	...
	vnx::write(out, value.tx_hash, type_code, type_code->fields[17].code.data());
	vnx::write(out, value.farmer_sig, type_code, type_code->fields[18].code.data());
	vnx::write(out, value.content_hash, type_code, type_code->fields[19].code.data());
	vnx::write(out, value.tx_list, type_code, type_code->fields[20].code.data());
}

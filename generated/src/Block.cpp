...
const vnx::Hash64 Block::VNX_CODE_HASH(0x6cec57bae352e5f6ull);
...
void Block::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, tx_hash);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, pool_sig);
...
void Block::write(std::ostream& _out) const {
	...
	_out << ", \"pool_sig\": "; vnx::write(_out, pool_sig);
...
void Block::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "pool_sig") {
			_entry.second.to(pool_sig);
...
std::shared_ptr<vnx::TypeCode> Block::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x6cec57bae352e5f6ull);
...
void read(TypeInput& in, ::mmx::Block& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 9: vnx::read(in, value.tx_hash, type_code, _field->code.data()); break;
			case 10: vnx::read(in, value.pool_sig, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::Block& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.tx_hash, type_code, type_code->fields[9].code.data());
	vnx::write(out, value.pool_sig, type_code, type_code->fields[10].code.data());

...
const vnx::Hash64 Block::VNX_CODE_HASH(0x9ee011fb83a0608bull);
...
void Block::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, time_stamp);
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, time_diff);
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, space_diff);
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, weight);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, total_weight);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, netspace_ratio);
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, txfee_buffer);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, vdf_iters);
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, vdf_output);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, vdf_reward_addr);
	_visitor.type_field(_type_code->fields[15], 15); vnx::accept(_visitor, vdf_reward_vote);
	_visitor.type_field(_type_code->fields[16], 16); vnx::accept(_visitor, proof);
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, proof_score_sum);
	_visitor.type_field(_type_code->fields[18], 18); vnx::accept(_visitor, reward_amount);
	_visitor.type_field(_type_code->fields[19], 19); vnx::accept(_visitor, reward_addr);
	_visitor.type_field(_type_code->fields[20], 20); vnx::accept(_visitor, reward_contract);
	_visitor.type_field(_type_code->fields[21], 21); vnx::accept(_visitor, reward_account);
	_visitor.type_field(_type_code->fields[22], 22); vnx::accept(_visitor, reward_vote);
	_visitor.type_field(_type_code->fields[23], 23); vnx::accept(_visitor, reward_vote_sum);
	_visitor.type_field(_type_code->fields[24], 24); vnx::accept(_visitor, reward_vote_count);
	_visitor.type_field(_type_code->fields[25], 25); vnx::accept(_visitor, base_reward);
	_visitor.type_field(_type_code->fields[26], 26); vnx::accept(_visitor, static_cost);
	_visitor.type_field(_type_code->fields[27], 27); vnx::accept(_visitor, total_cost);
	_visitor.type_field(_type_code->fields[28], 28); vnx::accept(_visitor, tx_count);
	_visitor.type_field(_type_code->fields[29], 29); vnx::accept(_visitor, tx_fees);
	_visitor.type_field(_type_code->fields[30], 30); vnx::accept(_visitor, tx_hash);
	_visitor.type_field(_type_code->fields[31], 31); vnx::accept(_visitor, farmer_sig);
	_visitor.type_field(_type_code->fields[32], 32); vnx::accept(_visitor, content_hash);
	_visitor.type_field(_type_code->fields[33], 33); vnx::accept(_visitor, tx_list);
...
void Block::write(std::ostream& _out) const {
	...
	_out << ", \"vdf_reward_vote\": "; vnx::write(_out, vdf_reward_vote);
...
vnx::Object Block::to_object() const {
	...
	_object["vdf_reward_vote"] = vdf_reward_vote;
	_object["proof"] = proof;
...
void Block::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "vdf_reward_vote") {
			_entry.second.to(vdf_reward_vote);
...
vnx::Variant Block::get_field(const std::string& _name) const {
	...
	if(_name == "vdf_reward_vote") {
		return vnx::Variant(vdf_reward_vote);
	}
	if(_name == "proof") {
...
void Block::set_field(const std::string& _name, const vnx::Variant& _value) {
	...
	} else if(_name == "vdf_reward_vote") {
		_value.to(vdf_reward_vote);
	} else if(_name == "proof") {
		_value.to(proof);
...
std::shared_ptr<vnx::TypeCode> Block::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x9ee011fb83a0608bull);
...
void read(TypeInput& in, ::mmx::Block& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 8: vnx::read(in, value.weight, type_code, _field->code.data()); break;
			case 9: vnx::read(in, value.total_weight, type_code, _field->code.data()); break;
			case 13: vnx::read(in, value.vdf_output, type_code, _field->code.data()); break;
			case 14: vnx::read(in, value.vdf_reward_addr, type_code, _field->code.data()); break;
			case 15: vnx::read(in, value.vdf_reward_vote, type_code, _field->code.data()); break;
			case 16: vnx::read(in, value.proof, type_code, _field->code.data()); break;
			case 19: vnx::read(in, value.reward_addr, type_code, _field->code.data()); break;
			case 20: vnx::read(in, value.reward_contract, type_code, _field->code.data()); break;
			case 21: vnx::read(in, value.reward_account, type_code, _field->code.data()); break;
			case 30: vnx::read(in, value.tx_hash, type_code, _field->code.data()); break;
			case 31: vnx::read(in, value.farmer_sig, type_code, _field->code.data()); break;
			case 32: vnx::read(in, value.content_hash, type_code, _field->code.data()); break;
			case 33: vnx::read(in, value.tx_list, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::Block& value, const TypeCode* type_code, const uint16_t* code) {
	...
	auto* const _buf = out.write(117);
	vnx::write_value(_buf + 0, value.version);
	vnx::write_value(_buf + 4, value.height);
	vnx::write_value(_buf + 8, value.nonce);
	vnx::write_value(_buf + 16, value.time_stamp);
	vnx::write_value(_buf + 24, value.time_diff);
	vnx::write_value(_buf + 32, value.space_diff);
	vnx::write_value(_buf + 40, value.netspace_ratio);
	vnx::write_value(_buf + 44, value.txfee_buffer);
	vnx::write_value(_buf + 52, value.vdf_iters);
	vnx::write_value(_buf + 60, value.proof_score_sum);
	vnx::write_value(_buf + 64, value.reward_amount);
	vnx::write_value(_buf + 72, value.reward_vote);
	vnx::write_value(_buf + 73, value.reward_vote_sum);
	vnx::write_value(_buf + 77, value.reward_vote_count);
	vnx::write_value(_buf + 81, value.base_reward);
	vnx::write_value(_buf + 89, value.static_cost);
	vnx::write_value(_buf + 97, value.total_cost);
	vnx::write_value(_buf + 105, value.tx_count);
	vnx::write_value(_buf + 109, value.tx_fees);
	...
	vnx::write(out, value.weight, type_code, type_code->fields[8].code.data());
	vnx::write(out, value.total_weight, type_code, type_code->fields[9].code.data());
	vnx::write(out, value.vdf_output, type_code, type_code->fields[13].code.data());
	vnx::write(out, value.vdf_reward_addr, type_code, type_code->fields[14].code.data());
	vnx::write(out, value.vdf_reward_vote, type_code, type_code->fields[15].code.data());
	vnx::write(out, value.proof, type_code, type_code->fields[16].code.data());
	vnx::write(out, value.reward_addr, type_code, type_code->fields[19].code.data());
	vnx::write(out, value.reward_contract, type_code, type_code->fields[20].code.data());
	vnx::write(out, value.reward_account, type_code, type_code->fields[21].code.data());
	vnx::write(out, value.tx_hash, type_code, type_code->fields[30].code.data());
	vnx::write(out, value.farmer_sig, type_code, type_code->fields[31].code.data());
	vnx::write(out, value.content_hash, type_code, type_code->fields[32].code.data());
	vnx::write(out, value.tx_list, type_code, type_code->fields[33].code.data());
}

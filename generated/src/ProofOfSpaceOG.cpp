...
const vnx::Hash64 ProofOfSpaceOG::VNX_CODE_HASH(0x2addfa76974b362full);
...
void ProofOfSpaceOG::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, local_key);
...
std::shared_ptr<vnx::TypeCode> ProofOfSpaceOG::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x2addfa76974b362full);
...
void read(TypeInput& in, ::mmx::ProofOfSpaceOG& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 6: vnx::read(in, value.local_key, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::ProofOfSpaceOG& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.local_key, type_code, type_code->fields[6].code.data());

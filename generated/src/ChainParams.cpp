...
void ChainParams::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, avg_txfee_adjust);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, min_vdf_segments);
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, num_vdf_segments);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, max_vdf_segments);
	...
	_visitor.type_field(_type_code->fields[40], 40); vnx::accept(_visitor, block_time);
	_visitor.type_field(_type_code->fields[41], 41); vnx::accept(_visitor, vdf_seed);
	...
	_visitor.type_field(_type_code->fields[48], 48); vnx::accept(_visitor, project_addr);
	_visitor.type_field(_type_code->fields[49], 49); vnx::accept(_visitor, fixed_project_reward);
	_visitor.type_field(_type_code->fields[50], 50); vnx::accept(_visitor, project_ratio);
...
void read(TypeInput& in, ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 41: vnx::read(in, value.vdf_seed, type_code, _field->code.data()); break;
			...
			case 48: vnx::read(in, value.project_addr, type_code, _field->code.data()); break;
			case 50: vnx::read(in, value.project_ratio, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 44, value.avg_txfee_adjust);
	vnx::write_value(_buf + 48, value.min_vdf_segments);
	vnx::write_value(_buf + 52, value.num_vdf_segments);
	vnx::write_value(_buf + 56, value.max_vdf_segments);
	...
	vnx::write_value(_buf + 240, value.block_time);
	...
	vnx::write(out, value.vdf_seed, type_code, type_code->fields[41].code.data());
	...
	vnx::write(out, value.project_addr, type_code, type_code->fields[48].code.data());
	vnx::write(out, value.project_ratio, type_code, type_code->fields[50].code.data());
}

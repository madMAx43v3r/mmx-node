...
const vnx::Hash64 ChainParams::VNX_CODE_HASH(0x489f1a8567e27a50ull);
...
void ChainParams::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[16], 16); vnx::accept(_visitor, max_weight_buffer);
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, virtual_lifetime);
...
std::shared_ptr<vnx::TypeCode> ChainParams::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x489f1a8567e27a50ull);
...
void write(TypeOutput& out, const ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 64, value.max_weight_buffer);
	vnx::write_value(_buf + 68, value.virtual_lifetime);
	vnx::write_value(_buf + 72, value.min_reward);
	...
	vnx::write_value(_buf + 208, value.blocks_per_year);

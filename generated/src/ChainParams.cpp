...
const vnx::Hash64 ChainParams::VNX_CODE_HASH(0x7539517aff75e855ull);
...
void ChainParams::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[34], 34); vnx::accept(_visitor, orphan_delay);
...
void ChainParams::write(std::ostream& _out) const {
	...
	_out << ", \"orphan_delay\": "; vnx::write(_out, orphan_delay);
...
vnx::Object ChainParams::to_object() const {
	...
	_object["orphan_delay"] = orphan_delay;
...
void ChainParams::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "orphan_delay") {
			_entry.second.to(orphan_delay);
...
vnx::Variant ChainParams::get_field(const std::string& _name) const {
	...
	if(_name == "orphan_delay") {
		return vnx::Variant(orphan_delay);
	}
	if(_name == "vdf_seed") {
...
void ChainParams::set_field(const std::string& _name, const vnx::Variant& _value) {
	...
	} else if(_name == "orphan_delay") {
		_value.to(orphan_delay);
...
std::shared_ptr<vnx::TypeCode> ChainParams::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x7539517aff75e855ull);
...
void write(TypeOutput& out, const ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 168, value.max_block_cost);
	vnx::write_value(_buf + 176, value.block_time);
	vnx::write_value(_buf + 184, value.orphan_delay);

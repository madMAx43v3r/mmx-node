...
const vnx::Hash64 ChainParams::VNX_CODE_HASH(0xbee121c5a5b92a1full);
...
void ChainParams::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, score_bits);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, score_target);
	_visitor.type_field(_type_code->fields[15], 15); vnx::accept(_visitor, score_threshold);
	_visitor.type_field(_type_code->fields[16], 16); vnx::accept(_visitor, target_mmx_gold_price);
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, min_reward);
	_visitor.type_field(_type_code->fields[18], 18); vnx::accept(_visitor, vdf_reward);
	_visitor.type_field(_type_code->fields[19], 19); vnx::accept(_visitor, vdf_reward_interval);
	...
	_visitor.type_field(_type_code->fields[22], 22); vnx::accept(_visitor, min_reward_adjust);
	_visitor.type_field(_type_code->fields[23], 23); vnx::accept(_visitor, time_diff_constant);
	_visitor.type_field(_type_code->fields[24], 24); vnx::accept(_visitor, space_diff_constant);
	_visitor.type_field(_type_code->fields[25], 25); vnx::accept(_visitor, virtual_space_constant);
...
void ChainParams::write(std::ostream& _out) const {
	...
	_out << ", \"min_reward_adjust\": "; vnx::write(_out, min_reward_adjust);
...
vnx::Object ChainParams::to_object() const {
	...
	_object["min_reward_adjust"] = min_reward_adjust;
...
void ChainParams::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "min_reward_adjust") {
			_entry.second.to(min_reward_adjust);
...
vnx::Variant ChainParams::get_field(const std::string& _name) const {
	...
	if(_name == "min_reward_adjust") {
		return vnx::Variant(min_reward_adjust);
	}
...
void ChainParams::set_field(const std::string& _name, const vnx::Variant& _value) {
	...
	} else if(_name == "min_reward_adjust") {
		_value.to(min_reward_adjust);
...
std::shared_ptr<vnx::TypeCode> ChainParams::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xbee121c5a5b92a1full);
...
void read(TypeInput& in, ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(type_code->is_matched) {
		...
		if(const auto* const _field = type_code->field_map[22]) {
			vnx::read_value(_buf + _field->offset, value.min_reward_adjust, _field->code.data());
		}
...
void write(TypeOutput& out, const ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 52, value.score_bits);
	vnx::write_value(_buf + 56, value.score_target);
	vnx::write_value(_buf + 60, value.score_threshold);
	vnx::write_value(_buf + 64, value.target_mmx_gold_price);
	vnx::write_value(_buf + 68, value.min_reward);
	vnx::write_value(_buf + 76, value.vdf_reward);
	vnx::write_value(_buf + 84, value.vdf_reward_interval);
	vnx::write_value(_buf + 88, value.reward_adjust_div);
	vnx::write_value(_buf + 92, value.reward_adjust_interval);
	vnx::write_value(_buf + 96, value.min_reward_adjust);
	...
	vnx::write_value(_buf + 140, value.min_txfee);
	vnx::write_value(_buf + 148, value.min_txfee_io);
	vnx::write_value(_buf + 156, value.min_txfee_sign);
	vnx::write_value(_buf + 164, value.min_txfee_memo);
	vnx::write_value(_buf + 172, value.min_txfee_exec);
	vnx::write_value(_buf + 180, value.min_txfee_deploy);
	vnx::write_value(_buf + 188, value.min_txfee_byte);
	vnx::write_value(_buf + 196, value.min_txfee_read);
	vnx::write_value(_buf + 204, value.min_txfee_read_kbyte);
	vnx::write_value(_buf + 212, value.max_block_size);
	vnx::write_value(_buf + 220, value.max_block_cost);
	vnx::write_value(_buf + 228, value.max_tx_cost);
	vnx::write_value(_buf + 236, value.block_interval_ms);
	vnx::write_value(_buf + 244, value.fixed_project_reward);
	vnx::write_value(_buf + 252, value.reward_activation);
	vnx::write_value(_buf + 256, value.transaction_activation);

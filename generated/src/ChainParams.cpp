...
const vnx::Hash64 ChainParams::VNX_CODE_HASH(0x386f7dcd84119f5full);
...
void ChainParams::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[33], 33); vnx::accept(_visitor, min_txfee_read_byte);
	...
	_visitor.type_field(_type_code->fields[39], 39); vnx::accept(_visitor, vdf_seed);
...
std::shared_ptr<vnx::TypeCode> ChainParams::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x386f7dcd84119f5full);
...
void read(TypeInput& in, ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 39: vnx::read(in, value.vdf_seed, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 188, value.min_txfee_read_byte);
	...
	vnx::write(out, value.vdf_seed, type_code, type_code->fields[39].code.data());

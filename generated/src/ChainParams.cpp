...
const vnx::Hash64 ChainParams::VNX_CODE_HASH(0x413d404c80cdef99ull);
...
void ChainParams::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, tby_factor);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, virtual_lifetime);
	...
	_visitor.type_field(_type_code->fields[24], 24); vnx::accept(_visitor, min_time_diff);
	...
	_visitor.type_field(_type_code->fields[33], 33); vnx::accept(_visitor, max_txbase_cost);
	...
	_visitor.type_field(_type_code->fields[36], 36); vnx::accept(_visitor, blocks_per_year);
	_visitor.type_field(_type_code->fields[37], 37); vnx::accept(_visitor, vdf_seed);
	_visitor.type_field(_type_code->fields[38], 38); vnx::accept(_visitor, offer_binary);
	_visitor.type_field(_type_code->fields[39], 39); vnx::accept(_visitor, tby_contract);
...
void ChainParams::write(std::ostream& _out) const {
	...
	_out << ", \"tby_factor\": "; vnx::write(_out, tby_factor);
	...
	_out << ", \"blocks_per_year\": "; vnx::write(_out, blocks_per_year);
	_out << ", \"vdf_seed\": "; vnx::write(_out, vdf_seed);
	_out << ", \"offer_binary\": "; vnx::write(_out, offer_binary);
	_out << ", \"tby_contract\": "; vnx::write(_out, tby_contract);
	_out << "}";
}
...
vnx::Object ChainParams::to_object() const {
	...
	_object["blocks_per_year"] = blocks_per_year;
	_object["vdf_seed"] = vdf_seed;
	_object["offer_binary"] = offer_binary;
	_object["tby_contract"] = tby_contract;
	return _object;
}
...
void ChainParams::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "blocks_per_year") {
			_entry.second.to(blocks_per_year);
		...
		} else if(_entry.first == "max_txbase_cost") {
			_entry.second.to(max_txbase_cost);
		...
		} else if(_entry.first == "tby_contract") {
			_entry.second.to(tby_contract);
		} else if(_entry.first == "tby_factor") {
			_entry.second.to(tby_factor);
...
vnx::Variant ChainParams::get_field(const std::string& _name) const {
	...
	if(_name == "max_txbase_cost") {
		return vnx::Variant(max_txbase_cost);
	}
	...
	if(_name == "blocks_per_year") {
		return vnx::Variant(blocks_per_year);
	}
	if(_name == "vdf_seed") {
	...
	if(_name == "tby_contract") {
		return vnx::Variant(tby_contract);
	}
	return vnx::Variant();
}
...
void ChainParams::set_field(const std::string& _name, const vnx::Variant& _value) {
	...
	} else if(_name == "tby_factor") {
		_value.to(tby_factor);
	...
	} else if(_name == "blocks_per_year") {
		_value.to(blocks_per_year);
	} else if(_name == "vdf_seed") {
		_value.to(vdf_seed);
	} else if(_name == "offer_binary") {
		_value.to(offer_binary);
	} else if(_name == "tby_contract") {
		_value.to(tby_contract);
	}
}
...
std::shared_ptr<vnx::TypeCode> ChainParams::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x413d404c80cdef99ull);
	...
	}
	{
		...
		field.value = vnx::to_string(12623040);
		field.code = {3};
	}
	{
	...
	}
	{
		...
		field.data_size = 4;
		field.name = "blocks_per_year";
		field.value = vnx::to_string(3155760);
		field.code = {3};
	}
	{
...
void read(TypeInput& in, ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(type_code->is_matched) {
		...
		if(const auto* const _field = type_code->field_map[13]) {
			vnx::read_value(_buf + _field->offset, value.tby_factor, _field->code.data());
		}
		...
		if(const auto* const _field = type_code->field_map[33]) {
			vnx::read_value(_buf + _field->offset, value.max_txbase_cost, _field->code.data());
		}
		...
		if(const auto* const _field = type_code->field_map[36]) {
			vnx::read_value(_buf + _field->offset, value.blocks_per_year, _field->code.data());
		}
	}
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			case 20: vnx::read(in, value.reward_factor, type_code, _field->code.data()); break;
			case 37: vnx::read(in, value.vdf_seed, type_code, _field->code.data()); break;
			case 38: vnx::read(in, value.offer_binary, type_code, _field->code.data()); break;
			case 39: vnx::read(in, value.tby_contract, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 52, value.tby_factor);
	vnx::write_value(_buf + 56, value.virtual_lifetime);
	...
	vnx::write_value(_buf + 180, value.max_txbase_cost);
	vnx::write_value(_buf + 188, value.max_block_cost);
	vnx::write_value(_buf + 196, value.block_time);
	vnx::write_value(_buf + 204, value.blocks_per_year);
	vnx::write(out, value.reward_factor, type_code, type_code->fields[20].code.data());
	vnx::write(out, value.vdf_seed, type_code, type_code->fields[37].code.data());
	vnx::write(out, value.offer_binary, type_code, type_code->fields[38].code.data());
	vnx::write(out, value.tby_contract, type_code, type_code->fields[39].code.data());
}

...
const vnx::Hash64 ChainParams::VNX_CODE_HASH(0x56824c7a7018fb72ull);
...
void ChainParams::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, virtual_lifetime);
	...
	_visitor.type_field(_type_code->fields[17], 17); vnx::accept(_visitor, max_weight_buffer);
	...
	_visitor.type_field(_type_code->fields[36], 36); vnx::accept(_visitor, offer_binary);
...
std::shared_ptr<vnx::TypeCode> ChainParams::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x56824c7a7018fb72ull);
...
void read(TypeInput& in, ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 36: vnx::read(in, value.offer_binary, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::ChainParams& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 52, value.virtual_lifetime);
	...
	vnx::write_value(_buf + 68, value.max_weight_buffer);
	...
	vnx::write(out, value.offer_binary, type_code, type_code->fields[36].code.data());
}

...
const vnx::Hash64 Transaction::VNX_CODE_HASH(0xadd876b8a9433bbaull);
...
void Transaction::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[3], 3); vnx::accept(_visitor, expires);
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, fee_ratio);
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, note);
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, salt);
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, sender);
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, inputs);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, outputs);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, exec_outputs);
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, execute);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, solutions);
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, deploy);
	_visitor.type_field(_type_code->fields[14], 14); vnx::accept(_visitor, parent);
	_visitor.type_field(_type_code->fields[15], 15); vnx::accept(_visitor, is_extendable);
...
std::shared_ptr<vnx::TypeCode> Transaction::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xadd876b8a9433bbaull);
	...
	type_code->methods[4] = ::mmx::Transaction_get_all_inputs::static_get_type_code();
	type_code->methods[5] = ::mmx::Transaction_get_all_outputs::static_get_type_code();
	type_code->methods[6] = ::mmx::Transaction_get_combined::static_get_type_code();
	type_code->methods[7] = ::mmx::Transaction_get_output::static_get_type_code();
	type_code->methods[8] = ::mmx::Transaction_get_outputs::static_get_type_code();
	type_code->methods[9] = ::mmx::Transaction_get_solution::static_get_type_code();
	type_code->methods[10] = ::mmx::Transaction_is_signed::static_get_type_code();
	type_code->methods[11] = ::mmx::Transaction_is_valid::static_get_type_code();
	type_code->methods[12] = ::mmx::Transaction_merge_sign::static_get_type_code();
	type_code->methods[13] = ::mmx::TransactionBase_calc_cost::static_get_type_code();
	type_code->methods[14] = ::mmx::TransactionBase_calc_hash::static_get_type_code();
...
void read(TypeInput& in, ::mmx::Transaction& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 5: vnx::read(in, value.note, type_code, _field->code.data()); break;
			case 6: vnx::read(in, value.salt, type_code, _field->code.data()); break;
			case 7: vnx::read(in, value.sender, type_code, _field->code.data()); break;
			case 8: vnx::read(in, value.inputs, type_code, _field->code.data()); break;
			case 9: vnx::read(in, value.outputs, type_code, _field->code.data()); break;
			case 10: vnx::read(in, value.exec_outputs, type_code, _field->code.data()); break;
			case 11: vnx::read(in, value.execute, type_code, _field->code.data()); break;
			case 12: vnx::read(in, value.solutions, type_code, _field->code.data()); break;
			case 13: vnx::read(in, value.deploy, type_code, _field->code.data()); break;
			case 14: vnx::read(in, value.parent, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::Transaction& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 8, value.expires);
	vnx::write_value(_buf + 12, value.fee_ratio);
	vnx::write_value(_buf + 16, value.is_extendable);
	vnx::write(out, value.id, type_code, type_code->fields[0].code.data());
	vnx::write(out, value.note, type_code, type_code->fields[5].code.data());
	vnx::write(out, value.salt, type_code, type_code->fields[6].code.data());
	vnx::write(out, value.sender, type_code, type_code->fields[7].code.data());
	vnx::write(out, value.inputs, type_code, type_code->fields[8].code.data());
	vnx::write(out, value.outputs, type_code, type_code->fields[9].code.data());
	vnx::write(out, value.exec_outputs, type_code, type_code->fields[10].code.data());
	vnx::write(out, value.execute, type_code, type_code->fields[11].code.data());
	vnx::write(out, value.solutions, type_code, type_code->fields[12].code.data());
	vnx::write(out, value.deploy, type_code, type_code->fields[13].code.data());
	vnx::write(out, value.parent, type_code, type_code->fields[14].code.data());
}

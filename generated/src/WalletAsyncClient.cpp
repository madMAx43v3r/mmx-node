...
uint64_t WalletAsyncClient::send(const uint32_t& index, const ::mmx::uint80& amount, const ::mmx::addr_t& dst_addr, const ::mmx::addr_t& currency, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::send_many(const uint32_t& index, const std::vector<std::pair<::mmx::addr_t, ::mmx::uint80>>& amounts, const ::mmx::addr_t& currency, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::send_from(const uint32_t& index, const ::mmx::uint80& amount, const ::mmx::addr_t& dst_addr, const ::mmx::addr_t& src_addr, const ::mmx::addr_t& currency, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::deposit(const uint32_t& index, const ::mmx::addr_t& address, const std::string& method, const std::vector<::vnx::Variant>& args, const ::mmx::uint80& amount, const ::mmx::addr_t& currency, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::make_offer(const uint32_t& index, const uint32_t& owner, const ::mmx::uint80& bid_amount, const ::mmx::addr_t& bid_currency, const ::mmx::uint80& ask_amount, const ::mmx::addr_t& ask_currency, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::offer_trade(const uint32_t& index, const ::mmx::addr_t& address, const ::mmx::uint80& amount, const uint32_t& dst_addr, const ::mmx::uint128& price, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::swap_trade(const uint32_t& index, const ::mmx::addr_t& address, const ::mmx::uint80& amount, const ::mmx::addr_t& currency, const vnx::optional<::mmx::uint80>& min_trade, const int32_t& num_iter, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::swap_add_liquid(const uint32_t& index, const ::mmx::addr_t& address, const std::array<::mmx::uint80, 2>& amount, const uint32_t& pool_idx, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::swap_rem_liquid(const uint32_t& index, const ::mmx::addr_t& address, const std::array<::mmx::uint80, 2>& amount, const ::mmx::spend_options_t& options, const std::function<void(std::shared_ptr<const ::mmx::Transaction>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::gather_inputs_for(const uint32_t& index, const ::mmx::uint80& amount, const ::mmx::addr_t& currency, const ::mmx::spend_options_t& options, const std::function<void(const std::vector<::mmx::txin_t>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t WalletAsyncClient::get_virtual_plots(const uint32_t& index, const std::function<void(const std::vector<::mmx::virtual_plot_info_t>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
	...
	const auto _request_id = ++vnx_next_id;
	{
		...
		vnx_queue_get_virtual_plots[_request_id] = std::make_pair(_callback, _error_callback);
	}
	vnx_request(_method, _request_id);
	return _request_id;
}
...
int32_t WalletAsyncClient::vnx_purge_request(uint64_t _request_id, const vnx::exception& _ex) {
	...
	switch(_index) {
		...
		case 34: {
			const auto _iter = vnx_queue_get_virtual_plots.find(_request_id);
			if(_iter != vnx_queue_get_virtual_plots.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_get_virtual_plots.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
...
int32_t WalletAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	...
	switch(_index) {
		...
		case 25: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::mmx::Wallet_get_history_memo_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
					_callback(_value->get_field_by_index(0).to<std::vector<::mmx::tx_entry_t>>());
				} else {
		...
		case 34: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::mmx::Wallet_get_virtual_plots_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {

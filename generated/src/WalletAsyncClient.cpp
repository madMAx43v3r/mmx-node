...
uint64_t WalletAsyncClient::get_offers(const uint32_t& index, const std::string& state, const std::function<void(const std::vector<::mmx::offer_data_t>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {

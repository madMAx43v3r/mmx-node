...
const vnx::Hash64 WebAPIBase::VNX_CODE_HASH(0x946108dc4725d5d6ull);
...
void WebAPIBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, sync_delay);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, cache_max_age);
...
std::shared_ptr<vnx::TypeCode> WebAPIBase::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x946108dc4725d5d6ull);
...
void write(TypeOutput& out, const ::mmx::WebAPIBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 4, value.sync_delay);
	vnx::write_value(_buf + 8, value.cache_max_age);

...
const uint32_t tx_exec_result_t::MAX_MESSAGE_LENGTH;

const vnx::Hash64 tx_exec_result_t::VNX_TYPE_HASH(0xd4c88a84145b5148ull);
const vnx::Hash64 tx_exec_result_t::VNX_CODE_HASH(0xb9b685036f3019c7ull);

vnx::Hash64 tx_exec_result_t::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string tx_exec_result_t::get_type_name() const {
	return "mmx.tx_exec_result_t";
}

const vnx::TypeCode* tx_exec_result_t::get_type_code() const {
	return mmx::vnx_native_type_code_tx_exec_result_t;
}

std::shared_ptr<tx_exec_result_t> tx_exec_result_t::create() {
	return std::make_shared<tx_exec_result_t>();
}

std::shared_ptr<tx_exec_result_t> tx_exec_result_t::clone() const {
	return std::make_shared<tx_exec_result_t>(*this);
}

void tx_exec_result_t::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void tx_exec_result_t::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void tx_exec_result_t::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::vnx_native_type_code_tx_exec_result_t;
...
void tx_exec_result_t::write(std::ostream& _out) const {
	_out << "{";
...
void tx_exec_result_t::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object tx_exec_result_t::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.tx_exec_result_t";
...
void tx_exec_result_t::from_object(const vnx::Object& _object) {
...
vnx::Variant tx_exec_result_t::get_field(const std::string& _name) const {
	if(_name == "did_fail") {
...
void tx_exec_result_t::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "did_fail") {
		_value.to(did_fail);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const tx_exec_result_t& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, tx_exec_result_t& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* tx_exec_result_t::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> tx_exec_result_t::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.tx_exec_result_t";
	type_code->type_hash = vnx::Hash64(0xd4c88a84145b5148ull);
	type_code->code_hash = vnx::Hash64(0xb9b685036f3019c7ull);
	type_code->is_native = true;
	type_code->native_size = sizeof(::mmx::tx_exec_result_t);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<vnx::Struct<tx_exec_result_t>>(); };
...
void write(TypeOutput& out, const ::mmx::tx_exec_result_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::vnx_native_type_code_tx_exec_result_t;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::tx_exec_result_t>(out);
	}
...
bool is_equivalent<::mmx::tx_exec_result_t>::operator()(const uint16_t* code, const TypeCode* type_code) {
	if(code[0] != CODE_STRUCT || !type_code) {
		return false;
	}
	type_code = type_code->depends[code[1]];
	return type_code->type_hash == ::mmx::tx_exec_result_t::VNX_TYPE_HASH && type_code->is_equivalent;
}

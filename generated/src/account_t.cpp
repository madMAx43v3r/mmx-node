...
const vnx::Hash64 account_t::VNX_CODE_HASH(0xcafd6c55ad2bfa23ull);
...
void account_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, with_passphrase);
...
std::shared_ptr<vnx::TypeCode> account_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0xcafd6c55ad2bfa23ull);

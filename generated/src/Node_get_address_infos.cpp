...
std::string Node_get_address_infos::get_type_name() const {
	return "mmx.Node.get_address_infos";
}

const vnx::TypeCode* Node_get_address_infos::get_type_code() const {
	return mmx::vnx_native_type_code_Node_get_address_infos;
}

std::shared_ptr<Node_get_address_infos> Node_get_address_infos::create() {
	return std::make_shared<Node_get_address_infos>();
}

std::shared_ptr<vnx::Value> Node_get_address_infos::clone() const {
	return std::make_shared<Node_get_address_infos>(*this);
}

void Node_get_address_infos::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Node_get_address_infos::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
...
void Node_get_address_infos::read(std::istream& _in) {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Node_get_address_infos& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Node_get_address_infos& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Node_get_address_infos::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Node_get_address_infos::static_create_type_code() {
	...
	type_code->native_size = sizeof(::mmx::Node_get_address_infos);
...
void write(TypeOutput& out, const ::mmx::Node_get_address_infos& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::vnx_native_type_code_Node_get_address_infos;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::Node_get_address_infos>(out);
	}

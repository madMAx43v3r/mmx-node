...
const vnx::Hash64 Wallet_revoke::VNX_CODE_HASH(0xb6405b18eda394bbull);

vnx::Hash64 Wallet_revoke::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string Wallet_revoke::get_type_name() const {
	return "mmx.Wallet.revoke";
}

const vnx::TypeCode* Wallet_revoke::get_type_code() const {
	return mmx::vnx_native_type_code_Wallet_revoke;
}

std::shared_ptr<Wallet_revoke> Wallet_revoke::create() {
	return std::make_shared<Wallet_revoke>();
}

std::shared_ptr<vnx::Value> Wallet_revoke::clone() const {
	return std::make_shared<Wallet_revoke>(*this);
}

void Wallet_revoke::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Wallet_revoke::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Wallet_revoke::accept(vnx::Visitor& _visitor) const {
...
void Wallet_revoke::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object Wallet_revoke::to_object() const {
	vnx::Object _object;
...
vnx::Variant Wallet_revoke::get_field(const std::string& _name) const {
	if(_name == "index") {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Wallet_revoke& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Wallet_revoke& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Wallet_revoke::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Wallet_revoke::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.Wallet.revoke";
	type_code->type_hash = vnx::Hash64(0x7470bb05bf1610caull);
	type_code->code_hash = vnx::Hash64(0xb6405b18eda394bbull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_method = true;
	type_code->native_size = sizeof(::mmx::Wallet_revoke);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<Wallet_revoke>(); };
...
void write(TypeOutput& out, const ::mmx::Wallet_revoke& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::vnx_native_type_code_Wallet_revoke;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::Wallet_revoke>(out);
	}

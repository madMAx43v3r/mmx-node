...
const vnx::Hash64 ProofOfTime::VNX_CODE_HASH(0x85c4c447ff48a72cull);
...
void ProofOfTime::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, infuse);
	_visitor.type_field(_type_code->fields[3], 3); vnx::accept(_visitor, segments);
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, timelord_key);
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, timelord_sig);
...
std::shared_ptr<vnx::TypeCode> ProofOfTime::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x85c4c447ff48a72cull);
...
void read(TypeInput& in, ::mmx::ProofOfTime& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			case 2: vnx::read(in, value.infuse, type_code, _field->code.data()); break;
			case 3: vnx::read(in, value.segments, type_code, _field->code.data()); break;
			case 4: vnx::read(in, value.timelord_key, type_code, _field->code.data()); break;
			case 5: vnx::read(in, value.timelord_sig, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::ProofOfTime& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.infuse, type_code, type_code->fields[2].code.data());
	vnx::write(out, value.segments, type_code, type_code->fields[3].code.data());
	vnx::write(out, value.timelord_key, type_code, type_code->fields[4].code.data());
	vnx::write(out, value.timelord_sig, type_code, type_code->fields[5].code.data());
}

...
const vnx::Hash64 trade_entry_t::VNX_CODE_HASH(0x65e779c1096d9a63ull);
...
void trade_entry_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, price);
...
std::shared_ptr<vnx::TypeCode> trade_entry_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x65e779c1096d9a63ull);
...
void write(TypeOutput& out, const ::mmx::trade_entry_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 20, value.price);

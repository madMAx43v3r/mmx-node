...
const vnx::Hash64 spend_options_t::VNX_CODE_HASH(0x6fbd8e0393e73b4dull);
...
void spend_options_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, pending_change);
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, exclude);
...
std::shared_ptr<vnx::TypeCode> spend_options_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x6fbd8e0393e73b4dull);
...
void read(TypeInput& in, ::mmx::spend_options_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			case 2: vnx::read(in, value.exclude, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::spend_options_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 4, value.pending_change);
	vnx::write(out, value.exclude, type_code, type_code->fields[2].code.data());
}

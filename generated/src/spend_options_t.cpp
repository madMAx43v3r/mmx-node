...
const vnx::Hash64 spend_options_t::VNX_CODE_HASH(0x8f5b473c6426bec6ull);
...
void spend_options_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, extra_fee);
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, sender);
	_visitor.type_field(_type_code->fields[3], 3); vnx::accept(_visitor, owner_map);
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, contract_map);
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, budget_map);
...
std::shared_ptr<vnx::TypeCode> spend_options_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x8f5b473c6426bec6ull);
...
void read(TypeInput& in, ::mmx::spend_options_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			case 2: vnx::read(in, value.sender, type_code, _field->code.data()); break;
			case 3: vnx::read(in, value.owner_map, type_code, _field->code.data()); break;
			case 4: vnx::read(in, value.contract_map, type_code, _field->code.data()); break;
			case 5: vnx::read(in, value.budget_map, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::spend_options_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 4, value.extra_fee);
	vnx::write(out, value.sender, type_code, type_code->fields[2].code.data());
	vnx::write(out, value.owner_map, type_code, type_code->fields[3].code.data());
	vnx::write(out, value.contract_map, type_code, type_code->fields[4].code.data());
	vnx::write(out, value.budget_map, type_code, type_code->fields[5].code.data());
}

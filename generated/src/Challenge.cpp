...
const vnx::Hash64 Challenge::VNX_CODE_HASH(0x793d7ddd5f7c61d8ull);
...
void Challenge::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, challenges);
...
void Challenge::write(std::ostream& _out) const {
	...
	_out << ", \"challenges\": "; vnx::write(_out, challenges);
...
void Challenge::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		if(_entry.first == "challenges") {
			_entry.second.to(challenges);
...
void Challenge::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "height") {
		_value.to(height);
	} else if(_name == "challenges") {
		_value.to(challenges);
...
std::shared_ptr<vnx::TypeCode> Challenge::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x793d7ddd5f7c61d8ull);
...
void read(TypeInput& in, ::mmx::Challenge& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			case 1: vnx::read(in, value.challenges, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::Challenge& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.challenges, type_code, type_code->fields[1].code.data());

...
const vnx::Hash64 ProofOfSpace::VNX_CODE_HASH(0x9d797ff4b3330efeull);
...
void ProofOfSpace::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, proof_bytes);
	_visitor.type_field(_type_code->fields[3], 3); vnx::accept(_visitor, local_key);
	_visitor.type_field(_type_code->fields[4], 4); vnx::accept(_visitor, farmer_key);
	_visitor.type_field(_type_code->fields[5], 5); vnx::accept(_visitor, pool_key);
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, local_sig);
...
std::shared_ptr<vnx::TypeCode> ProofOfSpace::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x9d797ff4b3330efeull);
...
void read(TypeInput& in, ::mmx::ProofOfSpace& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 2: vnx::read(in, value.proof_bytes, type_code, _field->code.data()); break;
			case 3: vnx::read(in, value.local_key, type_code, _field->code.data()); break;
			case 4: vnx::read(in, value.farmer_key, type_code, _field->code.data()); break;
			case 5: vnx::read(in, value.pool_key, type_code, _field->code.data()); break;
			case 6: vnx::read(in, value.local_sig, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::ProofOfSpace& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.proof_bytes, type_code, type_code->fields[2].code.data());
	vnx::write(out, value.local_key, type_code, type_code->fields[3].code.data());
	vnx::write(out, value.farmer_key, type_code, type_code->fields[4].code.data());
	vnx::write(out, value.pool_key, type_code, type_code->fields[5].code.data());
	vnx::write(out, value.local_sig, type_code, type_code->fields[6].code.data());
}

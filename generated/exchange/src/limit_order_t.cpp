...
const vnx::Hash64 limit_order_t::VNX_CODE_HASH(0x470da61e2da6cf56ull);
...
void limit_order_t::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[0], 0); vnx::accept(_visitor, ask);
	_visitor.type_field(_type_code->fields[1], 1); vnx::accept(_visitor, bid_keys);
...
std::shared_ptr<vnx::TypeCode> limit_order_t::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x470da61e2da6cf56ull);
...
void read(TypeInput& in, ::mmx::exchange::limit_order_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			case 1: vnx::read(in, value.bid_keys, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::exchange::limit_order_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 0, value.ask);
	vnx::write(out, value.bid_keys, type_code, type_code->fields[1].code.data());

...
const vnx::Hash64 MutableRelay_is_valid::VNX_TYPE_HASH(0xb0a0e3cc6a35c5d9ull);
const vnx::Hash64 MutableRelay_is_valid::VNX_CODE_HASH(0xa143f80ee7ec98a4ull);
...
std::string MutableRelay_is_valid::get_type_name() const {
	return "mmx.solution.MutableRelay.is_valid";
}
...
void MutableRelay_is_valid::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::solution::vnx_native_type_code_MutableRelay_is_valid;
	_visitor.type_begin(*_type_code);
	_visitor.type_end(*_type_code);
}

void MutableRelay_is_valid::write(std::ostream& _out) const {
	_out << "{\"__type\": \"mmx.solution.MutableRelay.is_valid\"";
	_out << "}";
}
...
vnx::Object MutableRelay_is_valid::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.solution.MutableRelay.is_valid";
	return _object;
}
...
std::shared_ptr<vnx::TypeCode> MutableRelay_is_valid::static_create_type_code() {
	...
	type_code->name = "mmx.solution.MutableRelay.is_valid";
	type_code->type_hash = vnx::Hash64(0xb0a0e3cc6a35c5d9ull);
	type_code->code_hash = vnx::Hash64(0xa143f80ee7ec98a4ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_method = true;
	type_code->native_size = sizeof(::mmx::solution::MutableRelay_is_valid);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<MutableRelay_is_valid>(); };
	type_code->is_const = true;
	type_code->return_type = ::mmx::solution::MutableRelay_is_valid_return::static_get_type_code();
	type_code->build();
	return type_code;
}
...
void write(TypeOutput& out, const ::mmx::solution::MutableRelay_is_valid& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::solution::vnx_native_type_code_MutableRelay_is_valid;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::solution::MutableRelay_is_valid>(out);
	}

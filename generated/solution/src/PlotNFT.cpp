...
std::shared_ptr<vnx::TypeCode> PlotNFT::static_create_type_code() {
	...
	type_code->methods[2] = ::mmx::solution::PlotNFT_calc_cost::static_get_type_code();
	type_code->methods[3] = ::mmx::solution::PlotNFT_is_valid::static_get_type_code();
...
std::shared_ptr<vnx::Value> PlotNFT::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
	switch(_method->get_type_hash()) {
		...
		case 0xa72be0dc67b9742dull: {
			auto _args = std::static_pointer_cast<const ::mmx::solution::PlotNFT_calc_cost>(_method);
			auto _return_value = ::mmx::solution::PlotNFT_calc_cost_return::create();
			_return_value->_ret_0 = calc_cost(_args->params);
			return _return_value;
		}

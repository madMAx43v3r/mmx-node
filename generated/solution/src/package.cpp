...
#include <mmx/solution/PlotNFT_calc_cost.hxx>
...
const TypeCode* type<::mmx::solution::PlotNFT_calc_cost>::get_type_code() {
	return mmx::solution::vnx_native_type_code_PlotNFT_calc_cost;
}

void type<::mmx::solution::PlotNFT_calc_cost>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::solution::PlotNFT_calc_cost());
}

void type<::mmx::solution::PlotNFT_calc_cost>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::solution::PlotNFT_calc_cost& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::mmx::solution::PlotNFT_calc_cost_return>::get_type_code() {
	return mmx::solution::vnx_native_type_code_PlotNFT_calc_cost_return;
}

void type<::mmx::solution::PlotNFT_calc_cost_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::solution::PlotNFT_calc_cost_return());
}

void type<::mmx::solution::PlotNFT_calc_cost_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::solution::PlotNFT_calc_cost_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}
...
const TypeCode* type<::mmx::solution::PuzzleLock_calc_cost>::get_type_code() {
	return mmx::solution::vnx_native_type_code_PuzzleLock_calc_cost;
}

void type<::mmx::solution::PuzzleLock_calc_cost>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::solution::PuzzleLock_calc_cost());
}

void type<::mmx::solution::PuzzleLock_calc_cost>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::solution::PuzzleLock_calc_cost& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::mmx::solution::PuzzleLock_calc_cost_return>::get_type_code() {
	return mmx::solution::vnx_native_type_code_PuzzleLock_calc_cost_return;
}

void type<::mmx::solution::PuzzleLock_calc_cost_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::solution::PuzzleLock_calc_cost_return());
}

void type<::mmx::solution::PuzzleLock_calc_cost_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::solution::PuzzleLock_calc_cost_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}
...
static void register_all_types() {
	...
	vnx::register_type_code(::mmx::solution::PlotNFT_calc_cost::static_create_type_code());
	vnx::register_type_code(::mmx::solution::PlotNFT_calc_cost_return::static_create_type_code());
	...
	vnx::register_type_code(::mmx::solution::PuzzleLock_calc_cost::static_create_type_code());
	vnx::register_type_code(::mmx::solution::PuzzleLock_calc_cost_return::static_create_type_code());
...
const vnx::TypeCode* const vnx_native_type_code_PlotNFT_calc_cost = vnx::get_type_code(vnx::Hash64(0xa72be0dc67b9742dull));
const vnx::TypeCode* const vnx_native_type_code_PlotNFT_calc_cost_return = vnx::get_type_code(vnx::Hash64(0x11c55408b4ce81e2ull));
...
const vnx::TypeCode* const vnx_native_type_code_PuzzleLock_calc_cost = vnx::get_type_code(vnx::Hash64(0xb166d83816f0591eull));
const vnx::TypeCode* const vnx_native_type_code_PuzzleLock_calc_cost_return = vnx::get_type_code(vnx::Hash64(0xaf88b511ec743d1cull));

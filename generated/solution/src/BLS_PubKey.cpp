...
std::shared_ptr<vnx::Value> BLS_PubKey::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
	switch(_method->get_type_hash()) {
		...
		case 0x71b0a63b1f81717cull: {
			auto _args = std::static_pointer_cast<const ::mmx::solution::BLS_PubKey_calc_hash>(_method);
			auto _return_value = ::mmx::solution::BLS_PubKey_calc_hash_return::create();
			_return_value->_ret_0 = calc_hash();
			return _return_value;
		}
	}

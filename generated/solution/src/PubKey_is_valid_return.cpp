...
const vnx::Hash64 PubKey_is_valid_return::VNX_TYPE_HASH(0xf9ef9f0cf08f3d6eull);
const vnx::Hash64 PubKey_is_valid_return::VNX_CODE_HASH(0x53d781d48c0cf24dull);
...
std::string PubKey_is_valid_return::get_type_name() const {
	return "mmx.solution.PubKey.is_valid.return";
}
...
void PubKey_is_valid_return::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::solution::vnx_native_type_code_PubKey_is_valid_return;
...
void PubKey_is_valid_return::write(std::ostream& _out) const {
	_out << "{\"__type\": \"mmx.solution.PubKey.is_valid.return\"";
...
vnx::Object PubKey_is_valid_return::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.solution.PubKey.is_valid.return";
...
std::shared_ptr<vnx::TypeCode> PubKey_is_valid_return::static_create_type_code() {
	...
	type_code->name = "mmx.solution.PubKey.is_valid.return";
	type_code->type_hash = vnx::Hash64(0xf9ef9f0cf08f3d6eull);
	type_code->code_hash = vnx::Hash64(0x53d781d48c0cf24dull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_return = true;
	type_code->native_size = sizeof(::mmx::solution::PubKey_is_valid_return);
...
void write(TypeOutput& out, const ::mmx::solution::PubKey_is_valid_return& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::solution::vnx_native_type_code_PubKey_is_valid_return;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::solution::PubKey_is_valid_return>(out);
	}

...
static void register_all_types() {
	vnx::register_type_code(::mmx::operation::Delegate::static_create_type_code());
...
const vnx::TypeCode* const vnx_native_type_code_Delegate = vnx::get_type_code(vnx::Hash64(0x43aacc899964c65aull));

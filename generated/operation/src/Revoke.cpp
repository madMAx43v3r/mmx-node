...
const vnx::Hash64 Revoke::VNX_TYPE_HASH(0xa8f48fce29a667d8ull);
const vnx::Hash64 Revoke::VNX_CODE_HASH(0x4f35f4d5322140a2ull);

vnx::Hash64 Revoke::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string Revoke::get_type_name() const {
	return "mmx.operation.Revoke";
}

const vnx::TypeCode* Revoke::get_type_code() const {
	return mmx::operation::vnx_native_type_code_Revoke;
}

std::shared_ptr<Revoke> Revoke::create() {
	return std::make_shared<Revoke>();
}

std::shared_ptr<vnx::Value> Revoke::clone() const {
	return std::make_shared<Revoke>(*this);
}

void Revoke::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Revoke::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Revoke::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::operation::vnx_native_type_code_Revoke;
...
void Revoke::write(std::ostream& _out) const {
	_out << "{\"__type\": \"mmx.operation.Revoke\"";
...
void Revoke::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object Revoke::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.operation.Revoke";
...
void Revoke::from_object(const vnx::Object& _object) {
...
vnx::Variant Revoke::get_field(const std::string& _name) const {
	if(_name == "version") {
...
void Revoke::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "version") {
		_value.to(version);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Revoke& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Revoke& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Revoke::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Revoke::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.operation.Revoke";
	type_code->type_hash = vnx::Hash64(0xa8f48fce29a667d8ull);
	type_code->code_hash = vnx::Hash64(0x4f35f4d5322140a2ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->native_size = sizeof(::mmx::operation::Revoke);
...
std::shared_ptr<vnx::Value> Revoke::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
...
void write(TypeOutput& out, const ::mmx::operation::Revoke& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::operation::vnx_native_type_code_Revoke;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::operation::Revoke>(out);
	}

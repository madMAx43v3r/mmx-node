...
const vnx::Hash64 Spend::VNX_CODE_HASH(0x219c073cfdab3c56ull);
...
std::shared_ptr<vnx::TypeCode> Spend::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x219c073cfdab3c56ull);
...
std::shared_ptr<vnx::Value> Spend::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
	switch(_method->get_type_hash()) {
		...
		case 0xb003cc8eafc55c09ull: {
			auto _args = std::static_pointer_cast<const ::mmx::operation::Spend_calc_hash>(_method);
			auto _return_value = ::mmx::operation::Spend_calc_hash_return::create();
			_return_value->_ret_0 = calc_hash();
			return _return_value;
		}
	}

...
std::shared_ptr<vnx::Value> Mint::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
	switch(_method->get_type_hash()) {
		...
		case 0xf916632c29371b49ull: {
			auto _args = std::static_pointer_cast<const ::mmx::operation::Mint_calc_hash>(_method);
			auto _return_value = ::mmx::operation::Mint_calc_hash_return::create();
			_return_value->_ret_0 = calc_hash();
			return _return_value;
		}
		case 0xa7633eba5c5afcecull: {
			auto _args = std::static_pointer_cast<const ::mmx::operation::Mint_is_valid>(_method);
			auto _return_value = ::mmx::operation::Mint_is_valid_return::create();
			_return_value->_ret_0 = is_valid();
			return _return_value;
		}
	}

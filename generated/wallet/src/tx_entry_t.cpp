...
std::string tx_entry_t::get_type_name() const {
	return "mmx.wallet.tx_entry_t";
}

const vnx::TypeCode* tx_entry_t::get_type_code() const {
	return mmx::wallet::vnx_native_type_code_tx_entry_t;
}
...
void tx_entry_t::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::wallet::vnx_native_type_code_tx_entry_t;
...
vnx::Object tx_entry_t::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.wallet.tx_entry_t";
...
std::shared_ptr<vnx::TypeCode> tx_entry_t::static_create_type_code() {
	...
	type_code->depends[0] = ::mmx::wallet::tx_type_e::static_get_type_code();
...
void write(TypeOutput& out, const ::mmx::wallet::tx_entry_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::wallet::vnx_native_type_code_tx_entry_t;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::wallet::tx_entry_t>(out);
	}
...
bool is_equivalent<::mmx::wallet::tx_entry_t>::operator()(const uint16_t* code, const TypeCode* type_code) {
	if(code[0] != CODE_STRUCT || !type_code) {
		return false;
	}
	type_code = type_code->depends[code[1]];
	return type_code->type_hash == ::mmx::wallet::tx_entry_t::VNX_TYPE_HASH && type_code->is_equivalent;
}

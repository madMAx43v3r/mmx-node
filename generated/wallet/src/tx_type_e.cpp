...
std::string tx_type_e::get_type_name() const {
	return "mmx.wallet.tx_type_e";
}

const vnx::TypeCode* tx_type_e::get_type_code() const {
	return mmx::wallet::vnx_native_type_code_tx_type_e;
}
...
vnx::Object tx_type_e::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.wallet.tx_type_e";
	_object["value"] = value;
	return _object;
}
...
void read(TypeInput& in, ::mmx::wallet::tx_type_e& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code) {
		...
		if(tmp.is_string()) {
			...
			value = ::mmx::wallet::tx_type_e::enum_t(tmp.to<uint32_t>());
		} else {
			value = ::mmx::wallet::tx_type_e();
		}
		return;
	}
	if(code) {
...
void write(TypeOutput& out, const ::mmx::wallet::tx_type_e& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::wallet::vnx_native_type_code_tx_type_e;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::wallet::tx_type_e>(out);
	}
...
void read(TypeInput& in, ::mmx::wallet::tx_type_e::enum_t& value, const TypeCode* type_code, const uint16_t* code) {
	uint32_t tmp = 0;
	vnx::read(in, tmp, type_code, code);
	value = ::mmx::wallet::tx_type_e::enum_t(tmp);
}

void write(TypeOutput& out, const ::mmx::wallet::tx_type_e::enum_t& value, const TypeCode* type_code, const uint16_t* code) {
	vnx::write(out, uint32_t(value), type_code, code);
}

template<>
std::string to_string(const ::mmx::wallet::tx_type_e& _value) {
	return _value.to_string();
}

template<>
std::string to_string_value(const ::mmx::wallet::tx_type_e& _value) {
	return _value.to_string_value();
}

template<>
std::string to_string_value_full(const ::mmx::wallet::tx_type_e& _value) {
	return _value.to_string_value_full();
}

template<>
std::string to_string(const ::mmx::wallet::tx_type_e::enum_t& _value) {
	return ::mmx::wallet::tx_type_e(_value).to_string();
}

template<>
std::string to_string_value(const ::mmx::wallet::tx_type_e::enum_t& _value) {
	return ::mmx::wallet::tx_type_e(_value).to_string_value();
}

template<>
std::string to_string_value_full(const ::mmx::wallet::tx_type_e::enum_t& _value) {
	return ::mmx::wallet::tx_type_e(_value).to_string_value_full();
}

bool is_equivalent<::mmx::wallet::tx_type_e>::operator()(const uint16_t* code, const TypeCode* type_code) {
	if(code[0] != CODE_STRUCT || !type_code) {
		return false;
	}
	type_code = type_code->depends[code[1]];
	return type_code->type_hash == ::mmx::wallet::tx_type_e::VNX_TYPE_HASH && type_code->is_equivalent;
}

...
#ifndef INCLUDE_mmx_wallet_tx_entry_t_HXX_
#define INCLUDE_mmx_wallet_tx_entry_t_HXX_
...
struct tx_entry_t {
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xd2325bd15e4a174full;
...
template<>
struct is_equivalent<::mmx::wallet::tx_entry_t> {
	bool operator()(const uint16_t* code, const TypeCode* type_code);
};

} // vnx

#endif // INCLUDE_mmx_wallet_tx_entry_t_HXX_

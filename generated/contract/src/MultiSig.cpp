...
std::shared_ptr<vnx::TypeCode> MultiSig::static_create_type_code() {
	...
	type_code->methods[7] = ::mmx::contract::MultiSig_add_owner::static_get_type_code();
	...
	type_code->methods[10] = ::mmx::contract::MultiSig_get_dependency::static_get_type_code();
	type_code->methods[11] = ::mmx::contract::MultiSig_get_parties::static_get_type_code();
	type_code->methods[12] = ::mmx::contract::MultiSig_is_valid::static_get_type_code();
	type_code->methods[13] = ::mmx::contract::MultiSig_rem_owner::static_get_type_code();
...
std::shared_ptr<vnx::Value> MultiSig::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
	switch(_method->get_type_hash()) {
		...
		case 0xaa2e4c882b71dd83ull: {
			auto _args = std::static_pointer_cast<const ::mmx::contract::MultiSig_add_owner>(_method);
			auto _return_value = ::mmx::contract::MultiSig_add_owner_return::create();
			add_owner(_args->address);
			return _return_value;
		}
		...
		case 0xd5b28a8ba1fda714ull: {
			auto _args = std::static_pointer_cast<const ::mmx::contract::MultiSig_get_dependency>(_method);
			auto _return_value = ::mmx::contract::MultiSig_get_dependency_return::create();
			_return_value->_ret_0 = get_dependency();
			return _return_value;
		}

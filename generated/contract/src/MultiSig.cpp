...
std::shared_ptr<vnx::TypeCode> MultiSig::static_create_type_code() {
	...
	type_code->methods[11] = ::mmx::contract::MultiSig_rem_owner::static_get_type_code();
	type_code->methods[12] = ::mmx::contract::MultiSig_set_num_required::static_get_type_code();

...
const vnx::Hash64 Executable::VNX_CODE_HASH(0x7f4376219a334369ull);
...
void Executable::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, constants);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, binary);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, init_method);
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, init_args);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, source);
...
void Executable::write(std::ostream& _out) const {
	...
	_out << ", \"constants\": "; vnx::write(_out, constants);
...
void Executable::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "constants") {
			_entry.second.to(constants);
...
std::shared_ptr<vnx::TypeCode> Executable::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x7f4376219a334369ull);
	...
	type_code->methods[9] = ::mmx::contract::TokenBase_calc_cost::static_get_type_code();
	type_code->methods[10] = ::mmx::contract::TokenBase_calc_hash::static_get_type_code();
	type_code->methods[11] = ::mmx::contract::TokenBase_is_valid::static_get_type_code();
...
void read(TypeInput& in, ::mmx::contract::Executable& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 8: vnx::read(in, value.constants, type_code, _field->code.data()); break;
			case 9: vnx::read(in, value.binary, type_code, _field->code.data()); break;
			case 10: vnx::read(in, value.init_method, type_code, _field->code.data()); break;
			case 11: vnx::read(in, value.init_args, type_code, _field->code.data()); break;
			case 12: vnx::read(in, value.source, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::contract::Executable& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.constants, type_code, type_code->fields[8].code.data());
	vnx::write(out, value.binary, type_code, type_code->fields[9].code.data());
	vnx::write(out, value.init_method, type_code, type_code->fields[10].code.data());
	vnx::write(out, value.init_args, type_code, type_code->fields[11].code.data());
	vnx::write(out, value.source, type_code, type_code->fields[12].code.data());
}

...
const vnx::Hash64 PuzzleTimeLock_calc_cost::VNX_TYPE_HASH(0xd932493507522b00ull);
const vnx::Hash64 PuzzleTimeLock_calc_cost::VNX_CODE_HASH(0x21c392b8e016e0a5ull);
...
std::string PuzzleTimeLock_calc_cost::get_type_name() const {
	return "mmx.contract.PuzzleTimeLock.calc_cost";
}
...
void PuzzleTimeLock_calc_cost::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::contract::vnx_native_type_code_PuzzleTimeLock_calc_cost;
...
void PuzzleTimeLock_calc_cost::write(std::ostream& _out) const {
	_out << "{\"__type\": \"mmx.contract.PuzzleTimeLock.calc_cost\"";
...
vnx::Object PuzzleTimeLock_calc_cost::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.contract.PuzzleTimeLock.calc_cost";
...
std::shared_ptr<vnx::TypeCode> PuzzleTimeLock_calc_cost::static_create_type_code() {
	...
	type_code->name = "mmx.contract.PuzzleTimeLock.calc_cost";
	type_code->type_hash = vnx::Hash64(0xd932493507522b00ull);
	type_code->code_hash = vnx::Hash64(0x21c392b8e016e0a5ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_method = true;
	type_code->native_size = sizeof(::mmx::contract::PuzzleTimeLock_calc_cost);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<PuzzleTimeLock_calc_cost>(); };
	type_code->is_const = true;
	type_code->return_type = ::mmx::contract::PuzzleTimeLock_calc_cost_return::static_get_type_code();
...
void write(TypeOutput& out, const ::mmx::contract::PuzzleTimeLock_calc_cost& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::contract::vnx_native_type_code_PuzzleTimeLock_calc_cost;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::contract::PuzzleTimeLock_calc_cost>(out);
	}

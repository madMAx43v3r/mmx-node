...
std::string Executable_calc_cost::get_type_name() const {
	return "mmx.contract.Executable.calc_cost";
}

const vnx::TypeCode* Executable_calc_cost::get_type_code() const {
	return mmx::contract::vnx_native_type_code_Executable_calc_cost;
}

std::shared_ptr<Executable_calc_cost> Executable_calc_cost::create() {
	return std::make_shared<Executable_calc_cost>();
}

std::shared_ptr<vnx::Value> Executable_calc_cost::clone() const {
	return std::make_shared<Executable_calc_cost>(*this);
}

void Executable_calc_cost::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Executable_calc_cost::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Executable_calc_cost::accept(vnx::Visitor& _visitor) const {
...
void Executable_calc_cost::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object Executable_calc_cost::to_object() const {
	vnx::Object _object;
...
vnx::Variant Executable_calc_cost::get_field(const std::string& _name) const {
	if(_name == "params") {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Executable_calc_cost& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Executable_calc_cost& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Executable_calc_cost::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Executable_calc_cost::static_create_type_code() {
	...
	type_code->native_size = sizeof(::mmx::contract::Executable_calc_cost);
...
void write(TypeOutput& out, const ::mmx::contract::Executable_calc_cost& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::contract::vnx_native_type_code_Executable_calc_cost;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::contract::Executable_calc_cost>(out);
	}

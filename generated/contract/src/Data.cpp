...
std::shared_ptr<vnx::TypeCode> Data::static_create_type_code() {
	...
	type_code->methods[9] = ::mmx::contract::Data_get_dependency::static_get_type_code();
	type_code->methods[10] = ::mmx::contract::Data_get_owner::static_get_type_code();
	type_code->methods[11] = ::mmx::contract::Data_num_bytes::static_get_type_code();
	type_code->methods[12] = ::mmx::contract::Data_set::static_get_type_code();
	type_code->methods[13] = ::mmx::contract::Data_transfer::static_get_type_code();
	type_code->methods[14] = ::mmx::contract::Data_validate::static_get_type_code();

...
const vnx::Hash64 Locked::VNX_CODE_HASH(0x3b8ecacc33b9fb7bull);
...
std::shared_ptr<vnx::TypeCode> Locked::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x3b8ecacc33b9fb7bull);
...
std::shared_ptr<vnx::Value> Locked::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {

...
std::string WebData_num_bytes::get_type_name() const {
	return "mmx.contract.WebData.num_bytes";
}

const vnx::TypeCode* WebData_num_bytes::get_type_code() const {
	return mmx::contract::vnx_native_type_code_WebData_num_bytes;
}

std::shared_ptr<WebData_num_bytes> WebData_num_bytes::create() {
	return std::make_shared<WebData_num_bytes>();
}

std::shared_ptr<vnx::Value> WebData_num_bytes::clone() const {
	return std::make_shared<WebData_num_bytes>(*this);
}

void WebData_num_bytes::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void WebData_num_bytes::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
...
void WebData_num_bytes::read(std::istream& _in) {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const WebData_num_bytes& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, WebData_num_bytes& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* WebData_num_bytes::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> WebData_num_bytes::static_create_type_code() {
	...
	type_code->native_size = sizeof(::mmx::contract::WebData_num_bytes);
...
void write(TypeOutput& out, const ::mmx::contract::WebData_num_bytes& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::contract::vnx_native_type_code_WebData_num_bytes;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::contract::WebData_num_bytes>(out);
	}

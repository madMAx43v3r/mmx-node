...
const vnx::Hash64 MultiSig_validate_return::VNX_CODE_HASH(0x5f519a522d990290ull);

vnx::Hash64 MultiSig_validate_return::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string MultiSig_validate_return::get_type_name() const {
	return "mmx.contract.MultiSig.validate.return";
}

const vnx::TypeCode* MultiSig_validate_return::get_type_code() const {
	return mmx::contract::vnx_native_type_code_MultiSig_validate_return;
}

std::shared_ptr<MultiSig_validate_return> MultiSig_validate_return::create() {
	return std::make_shared<MultiSig_validate_return>();
}

std::shared_ptr<vnx::Value> MultiSig_validate_return::clone() const {
	return std::make_shared<MultiSig_validate_return>(*this);
}

void MultiSig_validate_return::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void MultiSig_validate_return::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
...
void MultiSig_validate_return::read(std::istream& _in) {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const MultiSig_validate_return& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, MultiSig_validate_return& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* MultiSig_validate_return::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> MultiSig_validate_return::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.contract.MultiSig.validate.return";
	type_code->type_hash = vnx::Hash64(0x3635f63fd29dfd77ull);
	type_code->code_hash = vnx::Hash64(0x5f519a522d990290ull);
...
void write(TypeOutput& out, const ::mmx::contract::MultiSig_validate_return& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::contract::vnx_native_type_code_MultiSig_validate_return;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::contract::MultiSig_validate_return>(out);
	}

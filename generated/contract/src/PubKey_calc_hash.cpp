...
const vnx::Hash64 PubKey_calc_hash::VNX_TYPE_HASH(0x803fd5ba81d56d4cull);
const vnx::Hash64 PubKey_calc_hash::VNX_CODE_HASH(0xcb7744e8fc352a03ull);
...
std::string PubKey_calc_hash::get_type_name() const {
	return "mmx.contract.PubKey.calc_hash";
}
...
void PubKey_calc_hash::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::contract::vnx_native_type_code_PubKey_calc_hash;
	_visitor.type_begin(*_type_code);
	_visitor.type_end(*_type_code);
}

void PubKey_calc_hash::write(std::ostream& _out) const {
	_out << "{\"__type\": \"mmx.contract.PubKey.calc_hash\"";
	_out << "}";
}
...
vnx::Object PubKey_calc_hash::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.contract.PubKey.calc_hash";
	return _object;
}
...
std::shared_ptr<vnx::TypeCode> PubKey_calc_hash::static_create_type_code() {
	...
	type_code->name = "mmx.contract.PubKey.calc_hash";
	type_code->type_hash = vnx::Hash64(0x803fd5ba81d56d4cull);
	type_code->code_hash = vnx::Hash64(0xcb7744e8fc352a03ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_method = true;
	type_code->native_size = sizeof(::mmx::contract::PubKey_calc_hash);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<PubKey_calc_hash>(); };
	type_code->is_const = true;
	type_code->return_type = ::mmx::contract::PubKey_calc_hash_return::static_get_type_code();
	type_code->build();
	return type_code;
}
...
void write(TypeOutput& out, const ::mmx::contract::PubKey_calc_hash& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::contract::vnx_native_type_code_PubKey_calc_hash;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::contract::PubKey_calc_hash>(out);
	}

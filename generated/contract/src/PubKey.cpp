...
std::shared_ptr<vnx::TypeCode> PubKey::static_create_type_code() {
	...
	type_code->methods[10] = ::mmx::contract::PubKey_get_dependency::static_get_type_code();
	type_code->methods[11] = ::mmx::contract::PubKey_get_owner::static_get_type_code();
	type_code->methods[12] = ::mmx::contract::PubKey_get_parties::static_get_type_code();
	type_code->methods[13] = ::mmx::contract::PubKey_is_valid::static_get_type_code();

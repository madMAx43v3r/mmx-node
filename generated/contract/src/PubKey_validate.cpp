...
const vnx::Hash64 PubKey_validate::VNX_CODE_HASH(0x321893d2dc64c8cbull);

vnx::Hash64 PubKey_validate::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string PubKey_validate::get_type_name() const {
	return "mmx.contract.PubKey.validate";
}

const vnx::TypeCode* PubKey_validate::get_type_code() const {
	return mmx::contract::vnx_native_type_code_PubKey_validate;
}

std::shared_ptr<PubKey_validate> PubKey_validate::create() {
	return std::make_shared<PubKey_validate>();
}

std::shared_ptr<vnx::Value> PubKey_validate::clone() const {
	return std::make_shared<PubKey_validate>(*this);
}

void PubKey_validate::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void PubKey_validate::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
...
void PubKey_validate::read(std::istream& _in) {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const PubKey_validate& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, PubKey_validate& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* PubKey_validate::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> PubKey_validate::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.contract.PubKey.validate";
	type_code->type_hash = vnx::Hash64(0xc8c04e67ca0e5622ull);
	type_code->code_hash = vnx::Hash64(0x321893d2dc64c8cbull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_method = true;
	type_code->native_size = sizeof(::mmx::contract::PubKey_validate);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<PubKey_validate>(); };
	type_code->is_const = true;
	type_code->return_type = ::mmx::contract::PubKey_validate_return::static_get_type_code();
...
void write(TypeOutput& out, const ::mmx::contract::PubKey_validate& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::contract::vnx_native_type_code_PubKey_validate;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::contract::PubKey_validate>(out);
	}

...
std::string Executable_calc_hash::get_type_name() const {
	return "mmx.contract.Executable.calc_hash";
}

const vnx::TypeCode* Executable_calc_hash::get_type_code() const {
	return mmx::contract::vnx_native_type_code_Executable_calc_hash;
}

std::shared_ptr<Executable_calc_hash> Executable_calc_hash::create() {
	return std::make_shared<Executable_calc_hash>();
}

std::shared_ptr<vnx::Value> Executable_calc_hash::clone() const {
	return std::make_shared<Executable_calc_hash>(*this);
}

void Executable_calc_hash::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Executable_calc_hash::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
...
void Executable_calc_hash::read(std::istream& _in) {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Executable_calc_hash& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Executable_calc_hash& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Executable_calc_hash::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Executable_calc_hash::static_create_type_code() {
	...
	type_code->native_size = sizeof(::mmx::contract::Executable_calc_hash);
...
void write(TypeOutput& out, const ::mmx::contract::Executable_calc_hash& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::contract::vnx_native_type_code_Executable_calc_hash;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::contract::Executable_calc_hash>(out);
	}

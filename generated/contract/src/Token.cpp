...
const vnx::Hash64 Token::VNX_CODE_HASH(0x4ba61300aa062e3aull);
...
void Token::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[6], 6); vnx::accept(_visitor, web_url);
	_visitor.type_field(_type_code->fields[7], 7); vnx::accept(_visitor, icon_url);
	_visitor.type_field(_type_code->fields[8], 8); vnx::accept(_visitor, symbol);
	_visitor.type_field(_type_code->fields[9], 9); vnx::accept(_visitor, symbol_sig);
	_visitor.type_field(_type_code->fields[10], 10); vnx::accept(_visitor, decimals);
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, time_factor);
	_visitor.type_field(_type_code->fields[12], 12); vnx::accept(_visitor, stake_condition);
	_visitor.type_field(_type_code->fields[13], 13); vnx::accept(_visitor, stake_factors);
...
void Token::write(std::ostream& _out) const {
	...
	_out << ", \"symbol_sig\": "; vnx::write(_out, symbol_sig);
...
void Token::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "is_burnable") {
		...
		} else if(_entry.first == "symbol_sig") {
			_entry.second.to(symbol_sig);
...
void Token::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "version") {
		...
		_value.to(symbol);
	} else if(_name == "symbol_sig") {
		_value.to(symbol_sig);
...
std::shared_ptr<vnx::TypeCode> Token::static_create_type_code() {
	...
	type_code->code_hash = vnx::Hash64(0x4ba61300aa062e3aull);
...
void read(TypeInput& in, ::mmx::contract::Token& value, const TypeCode* type_code, const uint16_t* code) {
	...
	for(const auto* _field : type_code->ext_fields) {
		switch(_field->native_index) {
			...
			case 6: vnx::read(in, value.web_url, type_code, _field->code.data()); break;
			case 7: vnx::read(in, value.icon_url, type_code, _field->code.data()); break;
			case 8: vnx::read(in, value.symbol, type_code, _field->code.data()); break;
			case 9: vnx::read(in, value.symbol_sig, type_code, _field->code.data()); break;
			case 11: vnx::read(in, value.time_factor, type_code, _field->code.data()); break;
			case 12: vnx::read(in, value.stake_condition, type_code, _field->code.data()); break;
			case 13: vnx::read(in, value.stake_factors, type_code, _field->code.data()); break;
...
void write(TypeOutput& out, const ::mmx::contract::Token& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 6, value.decimals);
	...
	vnx::write(out, value.web_url, type_code, type_code->fields[6].code.data());
	vnx::write(out, value.icon_url, type_code, type_code->fields[7].code.data());
	vnx::write(out, value.symbol, type_code, type_code->fields[8].code.data());
	vnx::write(out, value.symbol_sig, type_code, type_code->fields[9].code.data());
	vnx::write(out, value.time_factor, type_code, type_code->fields[11].code.data());
	vnx::write(out, value.stake_condition, type_code, type_code->fields[12].code.data());
	vnx::write(out, value.stake_factors, type_code, type_code->fields[13].code.data());
}

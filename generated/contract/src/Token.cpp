...
void Token::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[11], 11); vnx::accept(_visitor, min_stake_duration);
...
void Token::write(std::ostream& _out) const {
	...
	_out << ", \"min_stake_duration\": "; vnx::write(_out, min_stake_duration);
	_out << "}";
}
...
vnx::Object Token::to_object() const {
	...
	_object["min_stake_duration"] = min_stake_duration;
	return _object;
}
...
void Token::from_object(const vnx::Object& _object) {
	for(const auto& _entry : _object.field) {
		...
		} else if(_entry.first == "min_stake_duration") {
			_entry.second.to(min_stake_duration);
...
vnx::Variant Token::get_field(const std::string& _name) const {
	...
	if(_name == "min_stake_duration") {
		return vnx::Variant(min_stake_duration);
	}
	return vnx::Variant();
}
...
void Token::set_field(const std::string& _name, const vnx::Variant& _value) {
	...
	} else if(_name == "min_stake_duration") {
		_value.to(min_stake_duration);
	}
}
...
void read(TypeInput& in, ::mmx::contract::Token& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(type_code->is_matched) {
		...
		if(const auto* const _field = type_code->field_map[11]) {
			vnx::read_value(_buf + _field->offset, value.min_stake_duration, _field->code.data());
		}
	}
...
void write(TypeOutput& out, const ::mmx::contract::Token& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write_value(_buf + 10, value.min_stake_duration);

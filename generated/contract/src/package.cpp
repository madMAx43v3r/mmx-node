...
void type<::mmx::contract::TokenInfo>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::contract::TokenInfo());
}

void type<::mmx::contract::TokenInfo>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::contract::TokenInfo& value, bool special) {
	code.push_back(CODE_OBJECT);
}
...
static void register_all_types() {
	...
	vnx::register_type_code(::mmx::contract::TokenInfo::static_create_type_code());
...
const vnx::TypeCode* const vnx_native_type_code_TokenInfo = vnx::get_type_code(vnx::Hash64(0xf2e8e1223091d639ull));

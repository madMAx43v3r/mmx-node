...
const TypeCode* type<::mmx::contract::Condition_calc_hash>::get_type_code() {
	return mmx::contract::vnx_native_type_code_Condition_calc_hash;
}

void type<::mmx::contract::Condition_calc_hash>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::contract::Condition_calc_hash());
}

void type<::mmx::contract::Condition_calc_hash>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::contract::Condition_calc_hash& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::mmx::contract::Condition_calc_hash_return>::get_type_code() {
	return mmx::contract::vnx_native_type_code_Condition_calc_hash_return;
}

void type<::mmx::contract::Condition_calc_hash_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::contract::Condition_calc_hash_return());
}

void type<::mmx::contract::Condition_calc_hash_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::contract::Condition_calc_hash_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::mmx::contract::Condition_calc_min_fee>::get_type_code() {
	return mmx::contract::vnx_native_type_code_Condition_calc_min_fee;
}

void type<::mmx::contract::Condition_calc_min_fee>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::contract::Condition_calc_min_fee());
}

void type<::mmx::contract::Condition_calc_min_fee>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::contract::Condition_calc_min_fee& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::mmx::contract::Condition_calc_min_fee_return>::get_type_code() {
	return mmx::contract::vnx_native_type_code_Condition_calc_min_fee_return;
}

void type<::mmx::contract::Condition_calc_min_fee_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::contract::Condition_calc_min_fee_return());
}

void type<::mmx::contract::Condition_calc_min_fee_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::contract::Condition_calc_min_fee_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::mmx::contract::Condition_is_valid>::get_type_code() {
	return mmx::contract::vnx_native_type_code_Condition_is_valid;
}

void type<::mmx::contract::Condition_is_valid>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::contract::Condition_is_valid());
}

void type<::mmx::contract::Condition_is_valid>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::contract::Condition_is_valid& value, bool special) {
	code.push_back(CODE_OBJECT);
}

const TypeCode* type<::mmx::contract::Condition_is_valid_return>::get_type_code() {
	return mmx::contract::vnx_native_type_code_Condition_is_valid_return;
}

void type<::mmx::contract::Condition_is_valid_return>::create_dynamic_code(std::vector<uint16_t>& code) {
	create_dynamic_code(code, ::mmx::contract::Condition_is_valid_return());
}

void type<::mmx::contract::Condition_is_valid_return>::create_dynamic_code(std::vector<uint16_t>& code, const ::mmx::contract::Condition_is_valid_return& value, bool special) {
	code.push_back(CODE_OBJECT);
}
...
static void register_all_types() {
	...
	vnx::register_type_code(::mmx::contract::Condition_calc_hash::static_create_type_code());
	vnx::register_type_code(::mmx::contract::Condition_calc_hash_return::static_create_type_code());
	vnx::register_type_code(::mmx::contract::Condition_calc_min_fee::static_create_type_code());
	vnx::register_type_code(::mmx::contract::Condition_calc_min_fee_return::static_create_type_code());
	vnx::register_type_code(::mmx::contract::Condition_is_valid::static_create_type_code());
	vnx::register_type_code(::mmx::contract::Condition_is_valid_return::static_create_type_code());
...
const vnx::TypeCode* const vnx_native_type_code_Condition_calc_hash = vnx::get_type_code(vnx::Hash64(0xb7bc1dda67724085ull));
const vnx::TypeCode* const vnx_native_type_code_Condition_calc_hash_return = vnx::get_type_code(vnx::Hash64(0xa12affd78caede98ull));
const vnx::TypeCode* const vnx_native_type_code_Condition_calc_min_fee = vnx::get_type_code(vnx::Hash64(0xd411b88bac1ead5aull));
const vnx::TypeCode* const vnx_native_type_code_Condition_calc_min_fee_return = vnx::get_type_code(vnx::Hash64(0xadbf0a2c1a4e49e4ull));
const vnx::TypeCode* const vnx_native_type_code_Condition_is_valid = vnx::get_type_code(vnx::Hash64(0x5f71bafb64aab7d9ull));
const vnx::TypeCode* const vnx_native_type_code_Condition_is_valid_return = vnx::get_type_code(vnx::Hash64(0xf8210b56192e01b8ull));

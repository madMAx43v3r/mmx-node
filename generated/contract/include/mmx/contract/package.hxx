...
extern const vnx::TypeCode* const vnx_native_type_code_Delegated; ///< \private
extern const vnx::TypeCode* const vnx_native_type_code_HTLC; ///< \private
...
extern const vnx::TypeCode* const vnx_native_type_code_Symbol; ///< \private
...
void read(TypeInput& in, ::mmx::contract::Delegated& value, const TypeCode* type_code, const uint16_t* code); ///< \private
void read(TypeInput& in, ::mmx::contract::HTLC& value, const TypeCode* type_code, const uint16_t* code); ///< \private
...
void read(TypeInput& in, ::mmx::contract::Symbol& value, const TypeCode* type_code, const uint16_t* code); ///< \private
...
void write(TypeOutput& out, const ::mmx::contract::Delegated& value, const TypeCode* type_code, const uint16_t* code); ///< \private
void write(TypeOutput& out, const ::mmx::contract::HTLC& value, const TypeCode* type_code, const uint16_t* code); ///< \private
...
void write(TypeOutput& out, const ::mmx::contract::Symbol& value, const TypeCode* type_code, const uint16_t* code); ///< \private
...
void read(std::istream& in, ::mmx::contract::Delegated& value); ///< \private
void read(std::istream& in, ::mmx::contract::HTLC& value); ///< \private
...
void read(std::istream& in, ::mmx::contract::Symbol& value); ///< \private
...
void write(std::ostream& out, const ::mmx::contract::Delegated& value); ///< \private
void write(std::ostream& out, const ::mmx::contract::HTLC& value); ///< \private
...
void write(std::ostream& out, const ::mmx::contract::Symbol& value); ///< \private
...
void accept(Visitor& visitor, const ::mmx::contract::Delegated& value); ///< \private
void accept(Visitor& visitor, const ::mmx::contract::HTLC& value); ///< \private
...
void accept(Visitor& visitor, const ::mmx::contract::Symbol& value); ///< \private
...
/// \private
template<>
struct type<::mmx::contract::Delegated> {
...
/// \private
template<>
struct type<::mmx::contract::Symbol> {

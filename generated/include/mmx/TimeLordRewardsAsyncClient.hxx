...
#ifndef INCLUDE_mmx_TimeLordRewards_ASYNC_CLIENT_HXX_
#define INCLUDE_mmx_TimeLordRewards_ASYNC_CLIENT_HXX_
...
class TimeLordRewardsAsyncClient : public vnx::AsyncClient {
public:
	TimeLordRewardsAsyncClient(const std::string& service_name);
	
	TimeLordRewardsAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_mmx_TimeLordRewards_ASYNC_CLIENT_HXX_

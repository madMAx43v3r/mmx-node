...
#ifndef INCLUDE_mmx_Wallet_get_history_memo_HXX_
...
class MMX_EXPORT Wallet_get_history_memo : public ::vnx::Value {
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xcbe6c5855e8776baull;
	
	Wallet_get_history_memo() {}
	
	vnx::Hash64 get_type_hash() const override;
	std::string get_type_name() const override;
	const vnx::TypeCode* get_type_code() const override;
	
	static std::shared_ptr<Wallet_get_history_memo> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const Wallet_get_history_memo& _value);
	friend std::istream& operator>>(std::istream& _in, Wallet_get_history_memo& _value);
...
#endif // INCLUDE_mmx_Wallet_get_history_memo_HXX_

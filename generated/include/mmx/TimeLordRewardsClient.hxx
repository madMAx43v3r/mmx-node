...
#ifndef INCLUDE_mmx_TimeLordRewards_CLIENT_HXX_
#define INCLUDE_mmx_TimeLordRewards_CLIENT_HXX_
...
class TimeLordRewardsClient : public vnx::Client {
public:
	TimeLordRewardsClient(const std::string& service_name);
	
	TimeLordRewardsClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_mmx_TimeLordRewards_CLIENT_HXX_

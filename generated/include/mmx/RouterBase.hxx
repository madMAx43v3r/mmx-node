...
void RouterBase::accept_generic(T& _visitor) const {
	...
	_visitor.type_field("input_vdfs", 13); _visitor.accept(input_vdfs);
	...
	_visitor.type_field("input_verified_blocks", 16); _visitor.accept(input_verified_blocks);
	_visitor.type_field("input_verified_transactions", 17); _visitor.accept(input_verified_transactions);
	_visitor.type_field("input_transactions", 18); _visitor.accept(input_transactions);
	_visitor.type_field("output_vdfs", 19); _visitor.accept(output_vdfs);
	_visitor.type_field("output_proof", 20); _visitor.accept(output_proof);
	_visitor.type_field("output_blocks", 21); _visitor.accept(output_blocks);
	_visitor.type_field("output_transactions", 22); _visitor.accept(output_transactions);
	_visitor.type_field("max_queue_ms", 23); _visitor.accept(max_queue_ms);
	_visitor.type_field("send_interval_ms", 24); _visitor.accept(send_interval_ms);
	_visitor.type_field("query_interval_ms", 25); _visitor.accept(query_interval_ms);
	_visitor.type_field("update_interval_ms", 26); _visitor.accept(update_interval_ms);
	_visitor.type_field("connect_interval_ms", 27); _visitor.accept(connect_interval_ms);
	_visitor.type_field("fetch_timeout_ms", 28); _visitor.accept(fetch_timeout_ms);
	_visitor.type_field("relay_target_ms", 29); _visitor.accept(relay_target_ms);
	_visitor.type_field("sync_loss_delay", 30); _visitor.accept(sync_loss_delay);
	_visitor.type_field("discover_interval", 31); _visitor.accept(discover_interval);
	_visitor.type_field("disconnect_interval", 32); _visitor.accept(disconnect_interval);
	_visitor.type_field("peer_retry_interval", 33); _visitor.accept(peer_retry_interval);
	_visitor.type_field("fork_check_interval", 34); _visitor.accept(fork_check_interval);
	_visitor.type_field("num_peers_out", 35); _visitor.accept(num_peers_out);
	_visitor.type_field("min_sync_peers", 36); _visitor.accept(min_sync_peers);
	_visitor.type_field("max_peer_set", 37); _visitor.accept(max_peer_set);
	_visitor.type_field("max_sent_cache", 38); _visitor.accept(max_sent_cache);
	_visitor.type_field("max_hash_cache", 39); _visitor.accept(max_hash_cache);

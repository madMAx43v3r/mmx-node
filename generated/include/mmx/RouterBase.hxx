...
public:
	...
	uint32_t max_connect_threads = 32;
...
void RouterBase::accept_generic(T& _visitor) const {
	...
	_visitor.type_field("max_connect_threads", 32); _visitor.accept(max_connect_threads);
	_visitor.type_field("min_sync_peers", 33); _visitor.accept(min_sync_peers);
	...
	_visitor.type_field("vdf_credits", 36); _visitor.accept(vdf_credits);
	_visitor.type_field("block_credits", 37); _visitor.accept(block_credits);
	_visitor.type_field("proof_credits", 38); _visitor.accept(proof_credits);
	_visitor.type_field("vdf_relay_cost", 39); _visitor.accept(vdf_relay_cost);
	_visitor.type_field("proof_relay_cost", 40); _visitor.accept(proof_relay_cost);
	_visitor.type_field("block_relay_cost", 41); _visitor.accept(block_relay_cost);
	_visitor.type_field("max_node_credits", 42); _visitor.accept(max_node_credits);
	_visitor.type_field("max_farmer_credits", 43); _visitor.accept(max_farmer_credits);

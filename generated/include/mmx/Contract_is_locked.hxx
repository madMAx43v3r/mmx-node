...
#ifndef INCLUDE_mmx_Contract_is_locked_HXX_
...
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x9b7981d03b3aeab6ull;
	...
	static std::shared_ptr<Contract_is_locked> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const Contract_is_locked& _value);
	friend std::istream& operator>>(std::istream& _in, Contract_is_locked& _value);
...
#endif // INCLUDE_mmx_Contract_is_locked_HXX_

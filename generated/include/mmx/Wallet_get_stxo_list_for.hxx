...
class MMX_EXPORT Wallet_get_stxo_list_for : public ::vnx::Value {
public:
...
template<typename T>
void Wallet_get_stxo_list_for::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Wallet_get_stxo_list_for>(2);
	_visitor.type_field("index", 0); _visitor.accept(index);
	_visitor.type_field("currency", 1); _visitor.accept(currency);
	_visitor.template type_end<Wallet_get_stxo_list_for>(2);
}

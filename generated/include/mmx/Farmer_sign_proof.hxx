...
#ifndef INCLUDE_mmx_Farmer_sign_proof_HXX_
...
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x7c59d2761514b455ull;
	...
	static std::shared_ptr<Farmer_sign_proof> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const Farmer_sign_proof& _value);
	friend std::istream& operator>>(std::istream& _in, Farmer_sign_proof& _value);
...
#endif // INCLUDE_mmx_Farmer_sign_proof_HXX_

...
void Partial::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Partial>(10);
	...
	_visitor.type_field("proof", 4); _visitor.accept(proof);
	_visitor.type_field("pool_url", 5); _visitor.accept(pool_url);
	_visitor.type_field("harvester", 6); _visitor.accept(harvester);
	_visitor.type_field("partial_diff", 7); _visitor.accept(partial_diff);
	_visitor.type_field("lookup_time_ms", 8); _visitor.accept(lookup_time_ms);
	_visitor.type_field("farmer_sig", 9); _visitor.accept(farmer_sig);
	_visitor.template type_end<Partial>(10);
}

...
template<typename T>
void TimeInfusion::accept_generic(T& _visitor) const {
	_visitor.template type_begin<TimeInfusion>(2);
	_visitor.type_field("chain", 0); _visitor.accept(chain);
	_visitor.type_field("values", 1); _visitor.accept(values);
	_visitor.template type_end<TimeInfusion>(2);
}

...
public:
	...
	int32_t validate_interval_ms = 60000;
...
void NodeBase::accept_generic(T& _visitor) const {
	...
	_visitor.type_field("validate_interval_ms", 16); _visitor.accept(validate_interval_ms);
	...
	_visitor.type_field("tx_pool_limit", 19); _visitor.accept(tx_pool_limit);

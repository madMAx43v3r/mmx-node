...
void NodeBase::accept_generic(T& _visitor) const {
	_visitor.template type_begin<NodeBase>(39);
	...
	_visitor.type_field("storage_path", 35); _visitor.accept(storage_path);
	_visitor.type_field("database_path", 36); _visitor.accept(database_path);
	_visitor.type_field("router_name", 37); _visitor.accept(router_name);
	_visitor.type_field("timelord_name", 38); _visitor.accept(timelord_name);
	_visitor.template type_end<NodeBase>(39);
}

...
void offer_data_t::accept_generic(T& _visitor) const {
	_visitor.template type_begin<offer_data_t>(12);
	...
	_visitor.type_field("bid_currency", 5); _visitor.accept(bid_currency);
	_visitor.type_field("ask_currency", 6); _visitor.accept(ask_currency);
	_visitor.type_field("bid_balance", 7); _visitor.accept(bid_balance);
	_visitor.type_field("ask_balance", 8); _visitor.accept(ask_balance);
	_visitor.type_field("ask_amount", 9); _visitor.accept(ask_amount);
	_visitor.type_field("inv_price", 10); _visitor.accept(inv_price);
	_visitor.type_field("price", 11); _visitor.accept(price);
	_visitor.template type_end<offer_data_t>(12);
}

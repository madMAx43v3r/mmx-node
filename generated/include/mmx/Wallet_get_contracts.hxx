...
class VNX_EXPORT Wallet_get_contracts : public ::vnx::Value {
public:
...
void Wallet_get_contracts::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Wallet_get_contracts>(1);
	_visitor.type_field("index", 0); _visitor.accept(index);
	_visitor.template type_end<Wallet_get_contracts>(1);
}

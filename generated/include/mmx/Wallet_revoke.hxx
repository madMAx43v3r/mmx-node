...
#ifndef INCLUDE_mmx_Wallet_revoke_HXX_
...
class MMX_EXPORT Wallet_revoke : public ::vnx::Value {
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x7470bb05bf1610caull;
	...
	static std::shared_ptr<Wallet_revoke> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const Wallet_revoke& _value);
	friend std::istream& operator>>(std::istream& _in, Wallet_revoke& _value);
...
#endif // INCLUDE_mmx_Wallet_revoke_HXX_

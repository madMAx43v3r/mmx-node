...
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xe07266bd4062b8bbull;
	
	Contract_validate_return() {}
	
	vnx::Hash64 get_type_hash() const override;
	std::string get_type_name() const override;
	const vnx::TypeCode* get_type_code() const override;
	
	static std::shared_ptr<Contract_validate_return> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const Contract_validate_return& _value);
	friend std::istream& operator>>(std::istream& _in, Contract_validate_return& _value);
...
#endif // INCLUDE_mmx_Contract_validate_return_HXX_

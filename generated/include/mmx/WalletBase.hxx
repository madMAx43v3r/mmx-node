...
protected:
	...
	virtual std::map<::mmx::addr_t, ::mmx::balance_t> get_total_balances_for(const std::vector<::mmx::addr_t>& addresses, const uint32_t& min_confirm) const = 0;
	...
	virtual void add_account(const uint32_t& index, const ::mmx::account_t& config, const vnx::optional<::mmx::hash_t>& passphrase) = 0;
	virtual void create_account(const ::mmx::account_t& config, const vnx::optional<::mmx::hash_t>& passphrase) = 0;
	virtual void create_wallet(const ::mmx::account_t& config, const vnx::optional<std::string>& words, const vnx::optional<::mmx::hash_t>& passphrase) = 0;

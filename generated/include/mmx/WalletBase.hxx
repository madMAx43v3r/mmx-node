...
protected:
	...
	virtual std::shared_ptr<const ::mmx::Transaction> revoke(const uint32_t& index, std::shared_ptr<const ::mmx::Transaction> prev, const ::mmx::spend_options_t& options) const = 0;

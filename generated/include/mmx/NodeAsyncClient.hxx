...
public:
	...
	uint64_t get_tx_key(const ::mmx::hash_t& id = ::mmx::hash_t(), 
			const std::function<void(const vnx::optional<::mmx::tx_key_t>&)>& _callback = std::function<void(const vnx::optional<::mmx::tx_key_t>&)>(),
			const std::function<void(const vnx::exception&)>& _error_callback = std::function<void(const vnx::exception&)>());
...
private:
	...
	std::unordered_map<uint64_t, std::pair<std::function<void(const vnx::optional<::mmx::tx_key_t>&)>, std::function<void(const vnx::exception&)>>> vnx_queue_get_tx_key;

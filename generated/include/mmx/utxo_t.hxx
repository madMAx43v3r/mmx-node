...
#ifndef INCLUDE_mmx_utxo_t_HXX_
#define INCLUDE_mmx_utxo_t_HXX_
...
struct MMX_EXPORT utxo_t : ::mmx::tx_out_t {
	...
	friend std::ostream& operator<<(std::ostream& _out, const utxo_t& _value);
	friend std::istream& operator>>(std::istream& _in, utxo_t& _value);
...
template<>
struct is_equivalent<::mmx::utxo_t> {
	bool operator()(const uint16_t* code, const TypeCode* type_code);
};

} // vnx

#endif // INCLUDE_mmx_utxo_t_HXX_

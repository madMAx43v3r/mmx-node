...
void ChainParams::accept_generic(T& _visitor) const {
	...
	_visitor.type_field("min_reward", 12); _visitor.accept(min_reward);
	_visitor.type_field("vdf_reward", 13); _visitor.accept(vdf_reward);
	_visitor.type_field("vdf_reward_interval", 14); _visitor.accept(vdf_reward_interval);
	_visitor.type_field("vdf_segment_size", 15); _visitor.accept(vdf_segment_size);
	_visitor.type_field("reward_adjust_div", 16); _visitor.accept(reward_adjust_div);
	_visitor.type_field("reward_adjust_tick", 17); _visitor.accept(reward_adjust_tick);
	_visitor.type_field("reward_adjust_interval", 18); _visitor.accept(reward_adjust_interval);
	_visitor.type_field("target_mmx_gold_price", 19); _visitor.accept(target_mmx_gold_price);
	_visitor.type_field("time_diff_divider", 20); _visitor.accept(time_diff_divider);
	...
	_visitor.type_field("escrow_binary", 47); _visitor.accept(escrow_binary);
	_visitor.type_field("time_lock_binary", 48); _visitor.accept(time_lock_binary);

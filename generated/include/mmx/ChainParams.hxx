...
public:
	...
	uint64_t reward_adjust_div = 1000000;
...
void ChainParams::accept_generic(T& _visitor) const {
	...
	_visitor.type_field("max_block_size", 34); _visitor.accept(max_block_size);
	_visitor.type_field("max_block_cost", 35); _visitor.accept(max_block_cost);
	_visitor.type_field("max_tx_cost", 36); _visitor.accept(max_tx_cost);
	_visitor.type_field("min_fee_ratio", 37); _visitor.accept(min_fee_ratio);
	_visitor.type_field("block_interval_ms", 38); _visitor.accept(block_interval_ms);
	...
	_visitor.type_field("reward_activation", 49); _visitor.accept(reward_activation);
	_visitor.type_field("transaction_activation", 50); _visitor.accept(transaction_activation);

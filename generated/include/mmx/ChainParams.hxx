...
public:
	...
	uint32_t min_reward_adjust = 10000;
...
void ChainParams::accept_generic(T& _visitor) const {
	...
	_visitor.type_field("score_bits", 13); _visitor.accept(score_bits);
	_visitor.type_field("score_target", 14); _visitor.accept(score_target);
	_visitor.type_field("score_threshold", 15); _visitor.accept(score_threshold);
	_visitor.type_field("target_mmx_gold_price", 16); _visitor.accept(target_mmx_gold_price);
	_visitor.type_field("min_reward", 17); _visitor.accept(min_reward);
	_visitor.type_field("vdf_reward", 18); _visitor.accept(vdf_reward);
	_visitor.type_field("vdf_reward_interval", 19); _visitor.accept(vdf_reward_interval);
	...
	_visitor.type_field("min_reward_adjust", 22); _visitor.accept(min_reward_adjust);

...
int main(int argc, char** argv)
{
	...
	std::vector<vm::instr_t> code;
	{
		...
		code.emplace_back(vm::OP_JUMPI, 0, code.size() - method.entry_point + 2, vm::MEM_STACK + 10);
		...
		code.emplace_back(vm::OP_JUMPI, 0, code.size() - method.entry_point + 3, vm::MEM_STACK + 10);
		code.emplace_back(vm::OP_CONV, 0, bin->fields["partner"], vm::MEM_STACK + 4, vm::CONVTYPE_UINT, vm::CONVTYPE_ADDRESS);
		code.emplace_back(vm::OP_JUMP, 0, code.size() - method.entry_point + 2);
	...
	}
	{
		...
		code.emplace_back(vm::OP_GET, 0, vm::MEM_STACK + 11, vm::MEM_EXTERN + vm::EXTERN_DEPOSIT, 0);
		code.emplace_back(vm::OP_COPY, 0, bin->fields["bid_currency"], vm::MEM_STACK + 11);
		code.emplace_back(vm::OP_GET, 0, vm::MEM_STACK + 11, vm::MEM_EXTERN + vm::EXTERN_DEPOSIT, 1);
	...
	}
	{
		...
		code.emplace_back(vm::OP_JUMPI, 0, code.size() - method.entry_point + 4, vm::MEM_STACK + 10);

...
void Transaction::add_input(const addr_t& currency, const addr_t& address, const uint80& amount)
{
	txin_t in;
	in.address = address;
...
void Transaction::add_output(const addr_t& currency, const addr_t& address, const uint80& amount, const vnx::optional<std::string>& memo)
{

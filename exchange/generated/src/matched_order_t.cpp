...
const vnx::Hash64 matched_order_t::VNX_CODE_HASH(0x64025b2079678f14ull);

vnx::Hash64 matched_order_t::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string matched_order_t::get_type_name() const {
	return "mmx.exchange.matched_order_t";
}

const vnx::TypeCode* matched_order_t::get_type_code() const {
	return mmx::exchange::vnx_native_type_code_matched_order_t;
}

std::shared_ptr<matched_order_t> matched_order_t::create() {
	return std::make_shared<matched_order_t>();
}

std::shared_ptr<matched_order_t> matched_order_t::clone() const {
	return std::make_shared<matched_order_t>(*this);
}

void matched_order_t::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void matched_order_t::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
...
void matched_order_t::read(std::istream& _in) {
...
void matched_order_t::from_object(const vnx::Object& _object) {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const matched_order_t& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, matched_order_t& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* matched_order_t::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> matched_order_t::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.exchange.matched_order_t";
	type_code->type_hash = vnx::Hash64(0xe730b5f024a17e86ull);
	type_code->code_hash = vnx::Hash64(0x64025b2079678f14ull);
...
void write(TypeOutput& out, const ::mmx::exchange::matched_order_t& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::exchange::vnx_native_type_code_matched_order_t;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::exchange::matched_order_t>(out);
	}
...
bool is_equivalent<::mmx::exchange::matched_order_t>::operator()(const uint16_t* code, const TypeCode* type_code) {
	if(code[0] != CODE_STRUCT || !type_code) {
		return false;
	}
	type_code = type_code->depends[code[1]];
	return type_code->type_hash == ::mmx::exchange::matched_order_t::VNX_TYPE_HASH && type_code->is_equivalent;
}

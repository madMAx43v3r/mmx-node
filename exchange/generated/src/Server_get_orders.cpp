...
const vnx::Hash64 Server_get_orders::VNX_CODE_HASH(0x4281fcddbd498f28ull);

vnx::Hash64 Server_get_orders::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string Server_get_orders::get_type_name() const {
	return "mmx.exchange.Server.get_orders";
}

const vnx::TypeCode* Server_get_orders::get_type_code() const {
	return mmx::exchange::vnx_native_type_code_Server_get_orders;
}

std::shared_ptr<Server_get_orders> Server_get_orders::create() {
	return std::make_shared<Server_get_orders>();
}

std::shared_ptr<vnx::Value> Server_get_orders::clone() const {
	return std::make_shared<Server_get_orders>(*this);
}

void Server_get_orders::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void Server_get_orders::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void Server_get_orders::accept(vnx::Visitor& _visitor) const {
...
void Server_get_orders::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object Server_get_orders::to_object() const {
	vnx::Object _object;
...
vnx::Variant Server_get_orders::get_field(const std::string& _name) const {
	if(_name == "pair") {
...
/// \private
std::ostream& operator<<(std::ostream& _out, const Server_get_orders& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, Server_get_orders& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* Server_get_orders::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> Server_get_orders::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.exchange.Server.get_orders";
	type_code->type_hash = vnx::Hash64(0x75d1f7f88288f10cull);
	type_code->code_hash = vnx::Hash64(0x4281fcddbd498f28ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->is_method = true;
	type_code->native_size = sizeof(::mmx::exchange::Server_get_orders);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<Server_get_orders>(); };
...
void write(TypeOutput& out, const ::mmx::exchange::Server_get_orders& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::exchange::vnx_native_type_code_Server_get_orders;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::exchange::Server_get_orders>(out);
	}

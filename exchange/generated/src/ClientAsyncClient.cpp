...
uint64_t ClientAsyncClient::get_trade_pairs(const std::string& server, const std::function<void(const std::vector<::mmx::exchange::trade_pair_t>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t ClientAsyncClient::get_trade_history(const std::string& server, const ::mmx::exchange::trade_pair_t& pair, const int32_t& limit, const std::function<void(const std::vector<::mmx::exchange::trade_entry_t>&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t ClientAsyncClient::get_min_trade(const std::string& server, const ::mmx::exchange::trade_pair_t& pair, const std::function<void(const ::mmx::ulong_fraction_t&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t ClientAsyncClient::make_offer(const uint32_t& wallet, const ::mmx::exchange::trade_pair_t& pair, const uint64_t& bid, const uint64_t& ask, const uint32_t& num_chunks, const std::function<void(std::shared_ptr<const ::mmx::exchange::OfferBundle>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t ClientAsyncClient::http_request(std::shared_ptr<const ::vnx::addons::HttpRequest> request, const std::string& sub_path, const std::function<void(std::shared_ptr<const ::vnx::addons::HttpResponse>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
int32_t ClientAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	...
	switch(_index) {
		...
		case 12: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::mmx::exchange::Client_get_trade_pairs_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
		...
		case 14: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::mmx::exchange::Client_get_trade_history_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
		...
		case 16: {
			...
			_lock.unlock();
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::mmx::exchange::Client_get_min_trade_return>(_value)) {
					_callback(_result->_ret_0);
				} else if(_value && !_value->is_void()) {
					_callback(_value->get_field_by_index(0).to<::mmx::ulong_fraction_t>());
				} else {

...
const vnx::Hash64 OrderBundle::VNX_TYPE_HASH(0xe4c159a5d79a29cdull);
const vnx::Hash64 OrderBundle::VNX_CODE_HASH(0x282f3849ed95e9dfull);

vnx::Hash64 OrderBundle::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string OrderBundle::get_type_name() const {
	return "mmx.exchange.OrderBundle";
}

const vnx::TypeCode* OrderBundle::get_type_code() const {
	return mmx::exchange::vnx_native_type_code_OrderBundle;
}

std::shared_ptr<OrderBundle> OrderBundle::create() {
	return std::make_shared<OrderBundle>();
}

std::shared_ptr<vnx::Value> OrderBundle::clone() const {
	return std::make_shared<OrderBundle>(*this);
}

void OrderBundle::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void OrderBundle::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void OrderBundle::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = mmx::exchange::vnx_native_type_code_OrderBundle;
...
void OrderBundle::write(std::ostream& _out) const {
	_out << "{\"__type\": \"mmx.exchange.OrderBundle\"";
...
void OrderBundle::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object OrderBundle::to_object() const {
	vnx::Object _object;
	_object["__type"] = "mmx.exchange.OrderBundle";
	_object["id"] = id;
...
void OrderBundle::from_object(const vnx::Object& _object) {
...
vnx::Variant OrderBundle::get_field(const std::string& _name) const {
	if(_name == "id") {
...
void OrderBundle::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "id") {
		_value.to(id);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const OrderBundle& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, OrderBundle& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* OrderBundle::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> OrderBundle::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "mmx.exchange.OrderBundle";
	type_code->type_hash = vnx::Hash64(0xe4c159a5d79a29cdull);
	type_code->code_hash = vnx::Hash64(0x282f3849ed95e9dfull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->native_size = sizeof(::mmx::exchange::OrderBundle);
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<OrderBundle>(); };
...
void write(TypeOutput& out, const ::mmx::exchange::OrderBundle& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = mmx::exchange::vnx_native_type_code_OrderBundle;
		out.write_type_code(type_code);
		vnx::write_class_header<::mmx::exchange::OrderBundle>(out);
	}

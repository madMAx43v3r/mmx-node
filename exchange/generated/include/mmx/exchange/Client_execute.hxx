...
#ifndef INCLUDE_mmx_exchange_Client_execute_HXX_
...
class MMX_EXCHANGE_EXPORT Client_execute : public ::vnx::Value {
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xa683dfd1653658acull;
	...
	static std::shared_ptr<Client_execute> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const Client_execute& _value);
	friend std::istream& operator>>(std::istream& _in, Client_execute& _value);
...
#endif // INCLUDE_mmx_exchange_Client_execute_HXX_

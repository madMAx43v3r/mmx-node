...
#ifndef INCLUDE_mmx_exchange_OrderBundle_HXX_
#define INCLUDE_mmx_exchange_OrderBundle_HXX_
...
class OrderBundle : public ::vnx::Value {
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xe4c159a5d79a29cdull;
	...
	static std::shared_ptr<OrderBundle> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const OrderBundle& _value);
	friend std::istream& operator>>(std::istream& _in, OrderBundle& _value);
...
#endif // INCLUDE_mmx_exchange_OrderBundle_HXX_

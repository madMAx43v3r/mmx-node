...
class MMX_EXCHANGE_EXPORT Server_execute : public ::vnx::Value {
public:
...
template<typename T>
void Server_execute::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Server_execute>(1);
	_visitor.type_field("tx", 0); _visitor.accept(tx);
	_visitor.template type_end<Server_execute>(1);
}

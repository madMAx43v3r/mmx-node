...
#ifndef INCLUDE_mmx_exchange_Server_place_HXX_
#define INCLUDE_mmx_exchange_Server_place_HXX_
...
public:
	...
	::mmx::exchange::limit_order_t order;
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x957913dc32e3d68cull;
	...
	static std::shared_ptr<Server_place> create();
	...
	friend std::ostream& operator<<(std::ostream& _out, const Server_place& _value);
	friend std::istream& operator>>(std::istream& _in, Server_place& _value);
...
#endif // INCLUDE_mmx_exchange_Server_place_HXX_

...
class MMX_EXCHANGE_EXPORT Server_get_price_return : public ::vnx::Value {
public:
...
template<typename T>
void Server_get_price_return::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Server_get_price_return>(1);
	_visitor.type_field("_ret_0", 0); _visitor.accept(_ret_0);
	_visitor.template type_end<Server_get_price_return>(1);
}
